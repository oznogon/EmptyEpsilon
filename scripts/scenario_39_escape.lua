...
function init()
    ...
    print(
        string.format(
            "    ----     Scenario: Escape    ----     Version %s    ----    Tested with EE version %s",
            scenario_version,
            ee_version
        )
    )
    ...
    friendlyStations = 0
    neutralStations = 0
    brigStation = SpaceStation()
        :setTemplate("Small Station")
        :setFaction("Kraylor")
        :setCallSign("DS23")
        :setPosition(912787, 148301)
    ...
    debris1 = Artifact()
        :setPosition(debrisx, debrisy)
        :setModel("ammo_box")
        :allowPickup(true)
        :setScanningParameters(2, 1)
        :onPickUp(function(debris, pGrab)
            string.format("")
            pGrab.debris1 = true
        end)
    debris1:setDescriptions(
        _("scienceDescription-debris", "Debris"),
        _(
            "scienceDescription-debris",
            "Debris: Various broken ship components. Possibly useful for engine or weapons systems repair"
        )
    )
    debrisx, debrisy = pickCoordinate(junkYardDebrisX, junkYardDebrisY)
    debris2 = Artifact()
        ...
        :setModel("ammo_box")
        :allowPickup(true)
        :setScanningParameters(1, 3)
        :onPickUp(function(debris, pGrab)
            string.format("")
            pGrab.debris2 = true
        end)
    debris2:setDescriptions(
        _("scienceDescription-debris", "Debris"),
        _(
            "scienceDescription-debris",
            "Debris: Various broken ship components. Possibly useful for shield or beam systems repair"
        )
    )
    debrisx, debrisy = pickCoordinate(junkYardDebrisX, junkYardDebrisY)
    debris3 = Artifact()
    ...
    debris3:setDescriptions(
        _("scienceDescription-debris", "Debris"),
        _(
            "scienceDescription-debris",
            "Debris: Various broken ship components. Possibly useful for hull or reactor systems repair"
        )
    )
    --Signs
    junkYardSignX = { 914126, 905479, 910303 }
    junkYardSignY = { 151100, 148728, 147102 }
    junkZone = Zone():setPoints(
        905479,
        148728,
        906490,
        146843,
    ...
    Sign1:setDescriptions(
        _("scienceDescription-buoy", "Space Message Buoy"),
        _(
            "scienceDescription-buoy",
            "Space Message Buoy reading 'Welcome to the Boris Junk Yard and Emporium' in the Kraylor language"
        )
    )
    signx, signy = pickCoordinate(junkYardSignX, junkYardSignY)
    Sign2 = Artifact()
        ...
        :allowPickup(false)
        :setScanningParameters(1, 1)
    Sign2:setDescriptions(
        _("scienceDescription-buoy", "Space Message Buoy"),
        _(
            "scienceDescription-buoy",
            "Space Message Buoy reading 'Boris Junk Yard: Browse for parts, take home an asteroid for the kids' in the Kraylor language"
        )
    )
    signx, signy = pickCoordinate(junkYardSignX, junkYardSignY)
    Sign3 = Artifact()
        ...
        :allowPickup(false)
        :setScanningParameters(1, 1)
    Sign3:setDescriptions(
        _("scienceDescription-buoy", "Space Message Buoy"),
        _(
            "scienceDescription-buoy",
            "Space Message Buoy reading 'Boris Junk Yard: Best prices in 20 sectors' in the Kraylor language"
        )
    )
    ...
    scrag_system_health = {
        ["reactor"] = {
            ...
            msg = _(
                "repair-msgEngineer&+",
                "Reached maximum repair on reactor"
            ),
        },
        ["beamweapons"] = {
            initial = -1,
            ...
            msg = _(
                "repair-msgEngineer&+",
                "Reached maximum repair on beam weapons"
            ),
        },
        ["maneuver"] = {
            initial = 0.05,
            ...
            msg = _(
                "repair-msgEngineer&+",
                "Reached maximum repair on maneuver"
            ),
        },
        ...
        ["impulse"] = {
            ...
            msg = _(
                "repair-msgEngineer&+",
                "Reached maximum repair on impulse engines"
            ),
        },
        ["warp"] = { initial = -1 },
        ["jumpdrive"] = { initial = -1 },
        ["frontshield"] = {
            ...
            msg = _(
                "repair-msgEngineer&+",
                "Reached maximum repair on shields"
            ),
        },
        ["rearshield"] = { initial = 0.1 },
    }
    playerFighter = PlayerSpaceship()
        :setFaction("Human Navy")
        :setTemplate("MP52 Hornet")
        :setCallSign("Scrag")
        :setPosition(912035, 152062)
    ...
    playerFighter:onDestruction(function()
        globalMessage(
            _(
                "defeat-msgMainscreen",
                "You were destroyed. The Human Navy did not receive your Kraylor intel."
            )
        )
        victory("Kraylor")
    end)
    ...
    junkStrikeship = CpuShip()
        ...
        :orderIdle()
        :setHull(0)
        :setShields(4.00, 0.00, 30.00, 30.00)
    ...
    for i, ship in ipairs(junkShips) do
        for j, system in ipairs(systems) do
            ship:setSystemHealth(system, random(-0.9, -0.1))
    ...
    plunder_system_health = {
        ["reactor"] = {
            max = 0.4,
            msg = _("repair-msgEngineer", "Reached maximum repair on reactor"),
        },
        ["beamweapons"] = {
            max = 0.8,
            msg = _(
        ...
        ["missilesystem"] = {
            ...
            msg = _(
                "repair-msgEngineer",
                "Reached maximum repair on missile weapons"
            ),
        },
        ["impulse"] = {
            max = 0.4,
        ...
        ["warp"] = {
            ...
            msg = _(
                "repair-msgEngineer",
                "Reached maximum repair on warp drive"
            ),
        },
        ["jumpdrive"] = {
            max = -0.1,
            msg = _(
                "repair-msgEngineer",
                "Reached maximum repair on jump drive"
            ),
        },
        ["frontshield"] = {
            max = 0.3,
            msg = _(
                "repair-msgEngineer",
                "Reached maximum repair on front shields"
            ),
        },
        ["rearshield"] = {
            max = 0.3,
            msg = _(
                "repair-msgEngineer",
                "Reached maximum repair on rear shield"
            ),
        },
    }
    junkRepulse:setSystemHealth("jumpdrive", -1):setBeamWeapon(1, 0, 0, 0, 0, 0)
    junkRepulse:setSystemHealthMax("jumpdrive", 0.5)
    junkSupply = SupplyDrop()
        :setFaction("Independent")
        :setPosition(909362, 151445)
        :setEnergy(500)
        :setWeaponStorage("Homing", 1)
        :setWeaponStorage("Nuke", 0)
        :setWeaponStorage("Mine", 0)
        :setWeaponStorage("EMP", 0)
    playerShipHealth = scragHealth --set function to constrain player ship health
    playerFighter:addToShipLog(
        string.format(
            _(
                "goal-shipLog",
                "You escaped the brig of station %s and transported yourselves onto one of the spaceship hulks in a nearby holding area for junked spacecraft. You carry critical information for the Human Navy regarding Kraylor activity in this area. You need to make good your escape and dock with a Human Navy space station"
            ),
            brigStation:getCallSign()
        ),
        "Magenta"
    )
...
function addRepulseToDatabase()
    ...
    if corvette_db ~= nil then
        corvette_db:setLongDescription(
            _(
                "scienceDB",
    ...
    repulse_db:setKeyValue(
        subclass_key,
        _("scienceDB", "Cruiser: Armored Transport")
    )
    ...
    repulse_db:setKeyValue(
        _("scienceDB", "Jump Range"),
        _("scienceDB", "5 - 50 U")
    )
    repulse_db:setKeyValue(
        _("scienceDB", "Sensor Ranges"),
        _("scienceDB", "Long: 38 U / Short: 5 U")
    )
    ...
    repulse_db:setKeyValue(
        _("scienceDB", "Beam weapon 90:200"),
        _("scienceDB", "Rng:1.2 Dmg:5 Cyc:6")
    )
    repulse_db:setKeyValue(
        _("scienceDB", "Beam weapon 270:200"),
        _("scienceDB", "Rng:1.2 Dmg:5 Cyc:6")
    )
...
function placeRandomAsteroidsAroundPoint(
    object_type,
    amount,
    dist_min,
    dist_max,
...
function buildNearbyStations()
    ...
    planetBaldwin
        ...
        :setDescription(
            _("scienceDescription-planet", "Mining and heavy industry")
        )
    stationWig =
        SpaceStation():setTemplate("Small Station"):setFaction("Kraylor")
    stationWig
        :setPosition(bwx, bwy + 3000)
        :setCallSign("BOBS")
        :setDescription(_("scienceDescription-station", "Baldwin Observatory"))
    stationWig.angle = 90
    gp = gp + 1
    ...
    planetMal
        :setAxialRotationTime(400.0)
        :setDescription(_("scienceDescription-planet", "M class planet"))
    stationMal =
        SpaceStation():setTemplate("Small Station"):setFaction("Independent")
    stationMal
        :setPosition(msx, msy + 3000)
        :setCallSign("MalNet")
        :setDescription(
            _(
                "scienceDescription-station",
                "Malastare communications network hub"
            )
        )
    stationMal.angle = 90
    gp = gp + 1
...
function handleDockedState()
    ...
    if comms_target == beamFixStation then
        if playerRepulse.beamFix == nil then
            addCommsReply(
                _("crewFriends-comms", "Talk to Kent's brother"),
                function()
                    setCommsMessage(
                        _(
                            "crewFriends-comms",
                            "Kent? You made it out of the Kraylor base? We thought you were going to spend the rest of your life there. Thank you, captain, for helping Kent get out of there."
                        )
                    )
                    addCommsReply(
                        _(
                            "crewFriends-comms",
                            "Can you help us with beam weapon repair?"
                        ),
                        function()
                            setCommsMessage(
                                _(
                                    "crewFriends-comms",
                                    "For the Repulse class? Absolutely. I used to work on those all the time."
                                )
                            )
                            playerRepulse:setBeamWeapon(
                                1,
                                10,
                                -90,
                                1200.0,
                            ...
                            plot1 = fixFlood
                            addCommsReply(
                                _("crewFriends-comms", "Thanks"),
                                function()
                                    setCommsMessage(
                                        _(
                                            "crewFriends-comms",
                                            "You're quite welcome. While I was in there, I fixed up your beams so they could function at maximum potential."
                                        )
                                    )
                                    playerRepulse:setSystemHealthMax(
                                        "beamweapons",
                                        1
                                    )
                                    addCommsReply(
                                        ...
                                        function()
                                            playerRepulse:addReputationPoints(
                                                30
                                            )
                                            setCommsMessage(
                                                _(
                                                    "crewFriends-comms",
                                                    "Thank *you* for getting my brother out of that Kraylor prison."
                                                )
                                            )
                                            addCommsReply(
                                                _("Back"),
    ...
    if comms_target == missileFixStation then
        if playerRepulse.missileFix == nil then
            addCommsReply(
                _("crewFriends-comms", "Talk to Edwina's father"),
                function()
                    setCommsMessage(
                        _(
                            "crewFriends-comms",
                            "I am glad to hear that Edwina escaped that prison. We were worried about her."
                        )
                    )
                    addCommsReply(
                        _(
                            "crewFriends-comms",
                            "Edwina says you do missile systems repair work"
                        ),
                        function()
                            setCommsMessage(
                                _(
                                    "crewFriends-comms",
                                    "Should be easy enough. I'm grateful to you for helping Edwina escape."
                                )
                            )
        ...
        if playerRepulse.impulseFix == nil then
            addCommsReply(_("crewFriends-comms", "Talk to Johnny"), function()
                setCommsMessage(
                    _(
                        "crewFriends-comms",
                        "Mom? Wow, I thought you were toast. Good to hear your voice."
                    )
                )
                addCommsReply(
                    _(
                        "crewFriends-comms",
                        "Can you get our impulse drive working better?"
                    ),
                    function()
                        if difficulty > 1 then
                            if impulseFixStation.good_base == nil then
                                repeat
                                    candidate = stationList[math.random(
                                        1,
                                        #stationList
                                    )]
                                    if
                                        candidate ~= nil and candidate:isValid()
                                    then
                                        local good_count = 0
                                        for good, good_data in
                                            pairs(candidate.comms_data.goods)
                                        do
                                        ...
                                        if good_count > 0 then
                                            for good, good_data in
                                                pairs(
                                                    candidate.comms_data.goods
                                                )
                                            do
                                                impulseFixStation.impulse_good =
                                                    good
                                            end
                                        end
                                    end
                                    if
                                        impulseFixStation.impulse_good
                                            ~= "food"
                                        and impulseFixStation.impulse_good
                                            ~= "medicine"
                                    then
                            ...
                            if
                                ...
                                and comms_source.goods[impulseFixStation.impulse_good] ~= nil
                                and comms_source.goods[impulseFixStation.impulse_good]
                                    > 0
                            then
                                impulse_good_quantity =
                                    comms_source.goods[impulseFixStation.impulse_good]
                            end
                            if impulse_good_quantity > 0 then
                                setCommsMessage(
                                    string.format(
                                        _(
                                            "crewFriends-comms",
                                            "Piece of cake. Thanks for the %s."
                                        ),
                                        comms_source.goods[impulseFixStation.impulse_good]
                                    )
                                )
                                ...
                                comms_source.goods[impulseFixStation.impulse_good] = comms_source.goods[impulseFixStation.impulse_good]
                                    - 1
                                comms_source.cargo = comms_source.cargo + 1
                                addCommsReply(
                                    _("crewFriends-comms", "Thank you"),
                                    function()
                                        setCommsMessage(
                                            _(
                                                "crewFriends-comms",
                                                "Sure, Mom. I'll see you at Christmas."
                                            )
                                        )
                                        playerRepulse:addReputationPoints(30)
                                        addCommsReply(_("Back"), commsStation)
                            ...
                            setCommsMessage(
                                _("crewFriends-comms", "Piece of cake.")
                            )
                            playerRepulse:setSystemHealthMax("impulse", 1)
                            playerRepulse.impulseFix = "done"
                            addCommsReply(
    ...
    if comms_target == jumpFixStation then
        if playerRepulse.jumpFix == nil then
            addCommsReply(
                _("crewFriends-comms", "Talk to Nancy's brother"),
                function()
                    setCommsMessage(
                        _(
                            "crewFriends-comms",
                            "Nancy! Last I heard, your ship had been captured by Kraylors and you were imprisoned. Good to know you won't be stuck there forever. What brings you here?"
                        )
                    )
                    addCommsReply(
                        _(
                            "crewFriends-comms",
                            "Our jump drive needs some tuning"
                        ),
                        function()
                            if difficulty >= 1 then
                                ...
                                if
                                    comms_source.goods ~= nil
                                    and comms_source.goods[jumpFixStation.jump_good] ~= nil
                                    and comms_source.goods[jumpFixStation.jump_good]
                                        > 0
                                then
                                    jump_good_quantity =
                                        comms_source.goods[jumpFixStation.jump_good]
                                end
                                if jump_good_quantity > 0 then
                                    setCommsMessage(
                                        string.format(
                                            _(
                                                "crewFriends-comms",
                                                "That should not be hard to do. I could probably do that in my sleep. Thanks for bringing %s."
                                            ),
                                            jumpFixStation.jump_good
                                        )
                                    )
                                    comms_source.goods[jumpFixStation.jump_good] = comms_source.goods[jumpFixStation.jump_good]
                                        - 1
                                    ...
                                    addCommsReply(
                                        _("crewFriends-comms", "Thanks, bro"),
                                        function()
                                            setCommsMessage(
                                                _(
                                                    "crewFriends-comms",
                                                    "No problem. Treat your jump drive right and it'll always bring you home."
                                                )
                                            )
                                            playerRepulse:addReputationPoints(
                                                30
                                    ...
                                    setCommsMessage(
                                        string.format(
                                            _(
                                                "crewFriends-comms",
                                                "That should not be hard to do. I could probably do that in my sleep. But I'll need some %s."
                                            ),
                                            jumpFixStation.jump_good
                                        )
                                    )
                                ...
                                setCommsMessage(
                                    _(
                                        "crewFriends-comms",
                                        "That should not be hard to do. I could probably do that in my sleep."
                                    )
                                )
    ...
    if comms_target == reactorFixStation then
        if playerRepulse.reactorFix == nil then
            addCommsReply(
                _("crewFriends-comms", "Talk to Manuel's cousin"),
                function()
                    setCommsMessage(
                        _(
                            "crewFriends-comms",
                            "Yo Manuel, why you want to scare us by getting captured, man? At least you escaped. Why you here?"
                        )
                    )
                    addCommsReply(
                        _(
                            "crewFriends-comms",
                            "The reactor is weak... real weak"
                        ),
                        function()
                            setCommsMessage(
                                _(
                                    "crewFriends-comms",
                                    "Lemme see if I can get it to charge up right."
                                )
                            )
                            ...
                            addCommsReply(
                                ...
                                function()
                                    setCommsMessage(
                                        _(
                                            "crewFriends-comms",
                                            "You're all set. Don't overheat the reactor or you'll get a nasty surprise."
                                        )
                                    )
                                    playerRepulse:addReputationPoints(30)
                                    addCommsReply(_("Back"), commsStation)
    ...
    if comms_target == longRangeFixStation then
        if playerRepulse.longRangeFix == nil then
            addCommsReply(
                _("crewFriends-comms", "Talk to Fred's wife"),
                function()
                    setCommsMessage(
                        _(
                            "crewFriends-comms",
                            "Fred! You escaped! We were worried sick."
                        )
                    )
                    addCommsReply(
                        _(
                            "crewFriends-comms",
                            "We need to connect to the Human Navy network"
                        ),
                        function()
                            setCommsMessage(
                                _(
                                    "crewFriends-comms",
                                    "I can do that for you. However, that means you'll go from being Independent to being in the Human Navy."
                                )
                            )
                            addCommsReply(
                                _(
                                    "crewFriends-comms",
                                    "I understand the consequences. Please proceed"
                                ),
                                function()
                                    playerRepulse.longRangeFix = "done"
                                    local px, py = playerRepulse:getPosition()
                                    local range =
                                        playerRepulse:getLongRangeRadarRange()
                                    local objects =
                                        getObjectsInRadius(px, py, range + 5000)
                                    local scanned_ships = {}
                                    local fully_scanned_ships = {}
                                    for i, obj in ipairs(objects) do
                                        if isObjectType(obj, "CpuShip") then
                                            if
                                                obj:isScannedBy(playerRepulse)
                                            then
                                                table.insert(scanned_ships, obj)
                                            end
                                            if
                                                obj:isFullyScannedBy(
                                                    playerRepulse
                                                )
                                            then
                                                table.insert(
                                    ...
                                    for j = 1, 8 do
                                        ...
                                        for i = 1, tSize do
                                            adjList =
                                                getAdjacentGridLocations(gx, gy)
                                            if #adjList < 1 then --exit loop if there are no more adjacent spaces available
                                                break
                                            end
                                            rd = math.random(1, #adjList) --random direction to grow from adjacent list
                                            grid[adjList[rd][1]][adjList[rd][2]] =
                                                gp
                                            table.insert(
                                                gRegion,
                                                {
                                        ...
                                        psx = brigx
                                            ...
                                            + random(
                                                -gSize / 2 * 0.95,
                                                gSize / 2 * 0.95
                                            ) --place station x coordinate
                                        psy = brigy
                                            + (gRegion[sri][2] - (gbHigh / 2)) * gSize
                                            + random(
                                                -gSize / 2 * 0.95,
                                                gSize / 2 * 0.95
                                            ) --place station y coordinate
                                        pStation = placeEStation(
                                            psx,
                                            psy,
                                            "RandomHumanNeutral",
                                            stationFaction
                                    ...
                                    addCommsReply(
                                        ...
                                        function()
                                            setCommsMessage(
                                                _(
                                                    "crewFriends-comms",
                                                    "You're welcome. Fred, honey, I'll see you after you get off work."
                                                )
                                            )
                                            playerRepulse:addReputationPoints(
                                                30
                            ...
                            addCommsReply(
                                _(
                                    "crewFriends-comms",
                                    "I'll check with the captain and get back to you"
                                ),
                                function()
                                    setCommsMessage(
                                        _("crewFriends-comms", "OK.")
                                    )
                                    addCommsReply(_("Back"), commsStation)
                                end
                            )
    ...
    if comms_target == shieldFixStation then
        if
            playerRepulse.frontShieldFix == nil
            and playerRepulse.rearShieldFix == nil
        then
            addCommsReply(
                _("crewFriends-comms", "Talk to Amir's sister"),
                function()
                    setCommsMessage(
                        string.format(
                            _(
                                "crewFriends-comms",
                                "Welcome to %s! Any friend of Amir's is a friend of mine."
                            ),
                            shieldFixStation:getCallSign()
                        )
                    )
                    addCommsReply(
                        _(
                            "crewFriends-comms",
                            "Can you help us with our shields?"
                        ),
                        function()
                            setCommsMessage(
                                _(
                                    "crewFriends-comms",
                                    "Yes, I can. However, I can only help with one: front or rear. I need more parts to do both."
                                )
                            )
                            addCommsReply(
                                _("crewFriends-comms", "Repair front shield"),
                                function()
                                    setCommsMessage(
                                        _(
                                            "crewFriends-comms",
                                            "Your front shields are now fully operational. Your repair crew can finish the rest."
                                        )
                                    )
                                    playerRepulse:setSystemHealthMax(
                                        "frontshield",
                                        ...
                                        function()
                                            ...
                                            setCommsMessage(
                                                string.format(
                                                    _(
                                                        "crewFriends-comms",
                                                        "Certainly. Bring back %s to get the rear shield fixed. You might find some at %s."
                                                    ),
                                                    shieldGood,
                                                    shieldGoodBase:getCallSign()
                                                )
                                            )
                                            playerRepulse:addReputationPoints(
                                                30
                            ...
                            addCommsReply(
                                _("crewFriends-comms", "Repair rear shield"),
                                function()
                                    setCommsMessage(
                                        _(
                                            "crewFriends-comms",
                                            "Your rear shields are now fully operational. Your repair crew can finish the rest."
                                        )
                                    )
                                    playerRepulse:setSystemHealthMax(
                                        "rearshield",
                                        ...
                                        function()
                                            ...
                                            setCommsMessage(
                                                string.format(
                                                    _(
                                                        "crewFriends-comms",
                                                        "Certainly. Bring back %s to get the front shield fixed. You might find some at %s."
                                                    ),
                                                    shieldGood,
                                                    shieldGoodBase:getCallSign()
                                                )
        ...
        elseif
            playerRepulse.frontShieldFix == nil
            or playerRepulse.rearShieldFix == nil
        then
            addCommsReply(
                _("crewFriends-comms", "Talk to Amir's sister"),
                function()
                    setCommsMessage(
                        string.format(
                            _(
                                "crewFriends-comms",
                                "Welcome back. Did you bring some %s for me to finish fixing up your shields?"
                            ),
                            shieldGood
                        )
                    )
                    ...
                    if
                        comms_source.goods ~= nil
                        and comms_source.goods[shieldGood] ~= nil
                        and comms_source.goods[shieldGood] > 0
                    then
                    ...
                    if shieldGoodQuantity > 0 then
                        addCommsReply(
                            string.format(
                                _(
                                    "crewFriends-comms",
                                    "Yes, please take the %s and fix the shields"
                                ),
                                shieldGood
                            ),
                            function()
                                comms_source.goods[shieldGood] = comms_source.goods[shieldGood]
                                    - 1
                                player.cargo = player.cargo + 1
                        ...
                        addCommsReply(
                            string.format(
                                _("crewFriends-comms", "Oops, no %s aboard"),
                                shieldGood
                            ),
                            function()
                                setCommsMessage(
                                    _("crewFriends-comms", "OK, good luck.")
                                )
                                addCommsReply(_("Back"), commsStation)
                            end
                        )
    ...
    if goodCount > 0 then
        addCommsReply(_("trade-comms", "Buy, sell, trade"), function()
            ...
            goodsReport = goodsReport
                .. string.format(
                    _("onBoardTrade-comms", "Current cargo aboard %s:\n"),
...
function stationStatusReport()
    addCommsReply(_("stationAssist-comms", "Report status"), function()
        msg = string.format(
            _("stationAssist-comms", "Hull:%s"),
            comms_target:getHullPercentage()
        )
        local shields = comms_target:getShieldCount()
        if shields == 1 then
            msg = string.format(
                _("stationAssist-comms", "%s\nShield:%s"),
                msg,
                math.floor(
        ...
        if comms_target:getSharesEnergyWithDocked() then
            msg = string.format(
                _(
                    "stationServices-comms",
                    "%s\nRecharge ship energy stores: nominal."
                ),
                msg
            )
        else
        ...
        for i, m_type in ipairs(missile_types) do
            if comms_target.comms_data.weapon_available[m_type.name] then
                if
                    missile_provision_msg
                    == _("ammo-comms", "Ordnance available:")
                then
                    missile_provision_msg = string.format(
                        _("ammo-comms", "%s %s@%i rep"),
                        missile_provision_msg,
                        m_type.desc,
                        getWeaponCost(m_type.name)
                    )
                else
                    missile_provision_msg = string.format(
                        _("ammo-comms", "%s, %s@%i rep"),
                ...
                if ctd.goodsKnowledge == nil then
                    ...
                    for i, station in ipairs(stationList) do
                        if
                            station ~= nil
                            and station:isValid()
                            and not station:isEnemy(comms_source)
                        then
                    ...
                    addCommsReply(
                        ...
                        function()
                            if comms_source.cargo > 0 then
                                ...
                                setCommsMessage(
                                    _("trade-comms", "Insufficient cargo space")
                                )
                            end
                            addCommsReply(_("Back"), commsShip)
                        end
...
function checkForSuffocationOnFighter(delta)
    ...
    if air_low_timer < 0 then
            ...
            if getScenarioTime() > early_hint_time then
                if hintRepulseTimer == nil or hintRepulseTimer > 0 then
                    if playerFighter.early_hint_msg_eng == nil then
                        ...
                        playerFighter:addCustomMessage(
                            "Engineering",
                            playerFighter.early_hint_msg_eng,
                            string.format(
                                _(
                                    "air-msgEngineer",
                                    "The Repulse ship %s seems like it's in the best condition. You should ask the science officer to scan it again to check the state of its engines."
                                ),
                                junkRepulse:getCallSign()
                            )
                        )
                    end
                    if playerFighter.early_hint_msg_epl == nil then
                        ...
                        playerFighter:addCustomMessage(
                            "Engineering+",
                            playerFighter.early_hint_msg_epl,
                            string.format(
                                _(
                                    "air-msgEngineer+",
                                    "The Repulse ship %s seems like it's in the best condition. You should ask the science officer to scan it again to check the state of its engines."
        ...
        local suffocation_label =
            _("airTimer-tabScience&Eng&Eng+&Ops", "Suffocation")
        ...
        if suffocation_label_minutes <= 0 then
            suffocation_label = string.format(
                _("airTimer-tabScience&Eng&Eng+&Ops", "%s %i"),
                suffocation_label,
                suffocation_label_seconds
            )
        else
            suffocation_label = string.format(
                _("airTimer-tabScience&Eng&Eng+&Ops", "%s %i:%.2i"),
                suffocation_label,
                suffocation_label_minutes,
                suffocation_label_seconds
            )
        end
        if playerFighter:hasPlayerAtPosition("Engineering") then
            if playerFighter.suffocation_message == nil then
                ...
                playerFighter:addCustomMessage(
                    "Engineering",
                    playerFighter.suffocation_message,
                    _(
                        "air-msgEngineer",
                        "Environmental systems show limited air remaining"
                    )
                )
            end
            playerFighter.suffocation_timer = "suffocation_timer"
            playerFighter:addCustomInfo(
                "Engineering",
                playerFighter.suffocation_timer,
                suffocation_label
            )
        end
        if playerFighter:hasPlayerAtPosition("Engineering+") then
            if playerFighter.suffocation_message_eng_plus == nil then
                playerFighter.suffocation_message_eng_plus =
                    "suffocation_message_eng_plus"
                playerFighter:addCustomMessage(
                    "Engineering+",
                    playerFighter.suffocation_message_eng_plus,
                    _(
            ...
            playerFighter.suffocation_timer_eng_plus =
                "suffocation_timer_eng_plus"
            playerFighter:addCustomInfo(
                "Engineering+",
                playerFighter.suffocation_timer_eng_plus,
                suffocation_label
        ...
        if playerFighter:hasPlayerAtPosition("DamageControl") then
            if playerFighter.suffocation_message_dmg_ctl == nil then
                playerFighter.suffocation_message_dmg_ctl =
                    "suffocation_message_dmg_ctl"
                playerFighter:addCustomMessage(
                    "DamageControl",
                    playerFighter.suffocation_message_dmg_ctl,
                    _(
                        "air-msgDamageControl",
                        "Environmental systems show limited air remaining"
                    )
                )
            end
            playerFighter.suffocation_timer_dmg_ctl =
                "suffocation_timer_dmg_ctl"
            playerFighter:addCustomInfo(
                "DamageControl",
                playerFighter.suffocation_timer_dmg_ctl,
                suffocation_label
        ...
        if playerFighter:hasPlayerAtPosition("Science") then
            if playerFighter.suffocation_message_science == nil then
                playerFighter.suffocation_message_science =
                    "suffocation_message_science"
                playerFighter:addCustomMessage(
                    "Science",
                    playerFighter.suffocation_message_science,
                    _(
            ...
            playerFighter.suffocation_timer_science =
                "suffocation_timer_science"
            playerFighter:addCustomInfo(
                "Science",
                playerFighter.suffocation_timer_science,
                suffocation_label
        ...
        if playerFighter:hasPlayerAtPosition("Operations") then
            if playerFighter.suffocation_message_ops == nil then
                playerFighter.suffocation_message_ops =
                    "suffocation_message_ops"
                playerFighter:addCustomMessage(
                    "Operations",
                    playerFighter.suffocation_message_ops,
                    _(
            ...
            playerFighter:addCustomInfo(
                "Operations",
                playerFighter.suffocation_timer_ops,
                suffocation_label
            )
        end
        if suffocation_timer < 0 then
            globalMessage(
                _(
                    "defeat-msgMainscreen",
                    "You suffocated while aboard the fighter hulk"
                )
            )
            victory("Kraylor")
    ...
    if hintRepulseTimer < 0 then
        if playerFighter:hasPlayerAtPosition("Engineering") then
            ...
            playerFighter:addCustomMessage(
                ...
                string.format(
                    _(
                        "transfer-msgEngineer",
                        "Reading through the scan data provided by science, you see that there could be a working jump drive on %s. However, if the crew wishes to transport over there, %s will need to get very close due to the minimal amount of energy remaining in the transporters."
                    ),
                    junkRepulse:getCallSign(),
                    playerFighter:getCallSign()
                )
            )
        end
        if playerFighter:hasPlayerAtPosition("Engineering+") then
    ...
    if playerFighter ~= nil and playerFighter:isValid() then
        if distance(playerFighter, junkRepulse) < 500 then
            if repulseTransferButton == nil then
                ...
                playerFighter:addCustomButton(
                    "Engineering",
                    repulseTransferButton,
                    _("crewTransfer-buttonEngineer", "Transfer to Repulse"),
                    repulseTransfer
                )
            end
            ...
            if repulseTransferButtonDmgCtl == nil then
                ...
                playerFighter:addCustomButton(
                    "DamageControl",
                    repulseTransferButtonDmgCtl,
                    _("crewTransfer-buttonDamageControl", "Transfer to Repulse"),
                    repulseTransfer
                )
            end
            plot1 = nil
...
function repulseTransfer()
    ...
    playerRepulse = PlayerSpaceship()
        :setFaction("Independent")
        :setTemplate("Repulse")
        :setCallSign("HMS Plunder")
        :setPosition(swapx, swapy)
    playerRepulse:setRotation(swapRotate) --set orientation that was saved
    for system, health in pairs(plunder_system_health) do
        playerRepulse:setSystemHealth(
            system,
            junkRepulse:getSystemHealth(system)
        )
        if health.max ~= nil then
    ...
    playerRepulse:setSystemHealth("jumpdrive", -0.2) --jump drive more damaged than sensors indicated
    playerRepulse
        :setHull(junkRepulse:getHull())
        :setEnergy(250)
    ...
    local transfer_systems =
        { "reactor", "beamweapons", "maneuver", "impulse", "frontshield" }
    for i, system in ipairs(transfer_systems) do
        junkFighter:setSystemHealthMax(
            system,
            playerFighter:getSystemHealth(system)
        ) --transfer repair level and fix
    end
    ...
    playerRepulse:addToShipLog(
        _(
            "transfer-shipLog",
            "Welcome aboard the Repulse class ship, rechristened HMS Plunder, currently registered as Independent"
        ),
        "Magenta"
    )
...
function augmentRepairCrew(delta)
    ...
    if augmentRepairCrewTimer < 0 then
        brigHailed = brigStation:sendCommsMessage(
            ...
            _(
                "crewImport-incCall",
                "Need a repair crew? We used to be posted on that ship. We would be happy to return to our repair duty and get away from these Kraylors. We left the transporters locked on us, but the Kraylors destroyed our remote activator. You should find an activation switch at the weapons console"
            )
        )
        if brigHailed then
            if playerRepulse:hasPlayerAtPosition("Weapons") then
                if retrieveRepairCrewButton == nil then
                    ...
                    playerRepulse:addCustomButton(
                        "Weapons",
                        retrieveRepairCrewButton,
                        _("crewTransfer-buttonWeapons", "Return Transport"),
                        returnRepairCrew
                    )
                end
            end
            if playerRepulse:hasPlayerAtPosition("Tactical") then
                if retrieveRepairCrewButtonTac == nil then
                    ...
                    playerRepulse:addCustomButton(
                        "Tactical",
                        retrieveRepairCrewButtonTac,
                        _("crewTransfer-buttonTactical", "Return Transport"),
                        returnRepairCrew
                    )
                end
            end
...
function beamDamageReport(delta)
    ...
    if beamDamageReportTimer < 0 then
        playerRepulse:addToShipLog(
            _(
                "crewRepair-shipLog",
                "Repair crew reports that the port beam weapon emplacement is currently non-functional. No applicable spare parts found aboard"
            ),
            "Magenta"
        )
    ...
    if jumpDamageReportTimer < 0 then
        if playerRepulse.debris1 then
            playerRepulse:addToShipLog(
                _(
                    "crewRepair-shipLog",
                    "Repair crew reports the jump drive not operational. However, they may be able to adapt some of the space debris picked up earlier into suitable replacement parts. They are starting the fabrication process now"
                ),
                "Magenta"
            )
            ...
            playerRepulse:addToShipLog(
                _(
                    "crewRepair-shipLog",
                    "Repair crew reports the jump drive inoperative. Additional parts are necessary"
                ),
                "Magenta"
            )
...
function missileDamageReport(delta)
    ...
    if missileDamageReportTimer < 0 then
        playerRepulse:addToShipLog(
            _(
                "crewRepair-shipLog",
                "Repair crew says the missle weapons systems are not repairable with available components"
            ),
            "Magenta"
        )
    ...
    if hull_damage_report_timer < 0 then
        ...
        if playerRepulse.debris3 then
            ...
            playerRepulse:addToShipLog(
                _(
                    "crewRepair-shipLog",
                    "Repair crew applied some of the parts picked up to make some repairs on the hull"
                ),
                "Magenta"
            )
        end
...
function damageSummaryReport(delta)
    ...
    for i, system in ipairs(diff_systems) do
        total_diff = total_diff
            + math.abs(
                playerRepulse:getSystemHealthMax(system)
                    - playerRepulse:getSystemHealth(system)
            )
    end
    if total_diff < 0.1 then
        playerRepulse:addToShipLog(
            _(
                "crewRepair-shipLog",
                "Repair crew reports they have repaired as much as they can. Additional parts may be available in the junk yard. We have not been able to get long range communications online, so we are as yet unable to locate or contact any Human Navy stations."
            ),
            "Magenta"
        )
        plot1 = nil
            ...
            if missileFixStationMessage == nil then
                playerRepulse:addToShipLog(
                    string.format(
                        _(
                            "crewFriends-shipLog",
                            "[Edwina (repair crew member)] My dad can fix our missile systems. He's got years of experience. He's on %s"
                        ),
                        missileFixStation:getCallSign()
                    ),
                    "Magenta"
                )
        ...
        if shieldFixStation == nil then
            repeat
                ...
                if
                    ...
                    and candidate:isValid()
                    and candidate ~= beamFixStation
                    and candidate ~= missileFixStation
                then
            ...
            if shieldFixStationMessage == nil then
                playerRepulse:addToShipLog(
                    string.format(
                        _(
                            "crewFriends-shipLog",
                            "[Amir (repair crew member)] My sister fixes shield systems. I bet she could easily get our shields working. She works at a shop on %s"
                        ),
                        shieldFixStation:getCallSign()
                    ),
                    "Magenta"
        ...
        if impulseFixStation == nil then
            repeat
                ...
                if
                    ...
                    and candidate ~= beamFixStation
                    and candidate ~= missileFixStation
                    and candidate ~= shieldFixStation
                then
            ...
            if impulseFixStationMessage == nil then
                playerRepulse:addToShipLog(
                    string.format(
                        _(
                            "crewFriends-shipLog",
                            "[Janet (repair crew member)] Johnny, my son, does practical research on impulse drives. He's on %s. He can probably get our impulse engines up to full capacity"
                        ),
                        impulseFixStation:getCallSign()
                    ),
                    "Magenta"
                )
        ...
        if longRangeFixStation == nil then
            repeat
                ...
                if
                    ...
                    and candidate ~= missileFixStation
                    and candidate ~= shieldFixStation
                    and candidate ~= impulseFixStation
                then
            ...
            if longRangeFixStationMessage == nil then
                playerRepulse:addToShipLog(
                    string.format(
                        _(
                            "crewFriends-shipLog",
                            "[Fred (repair crew member)] The outfit my wife works for on %s specializes in long range communication. She could probably get our systems connected back up to the Human Navy communication network"
                        ),
                        longRangeFixStation:getCallSign()
                    ),
                    "Magenta"
                )
        ...
        if jumpFixStation == nil then
            repeat
                ...
                if
                    ...
                    and candidate ~= shieldFixStation
                    and candidate ~= impulseFixStation
                    and candidate ~= longRangeFixStation
                then
            ...
            if jumpFixStationMessage == nil then
                playerRepulse:addToShipLog(
                    string.format(
                        _(
                            "crewFriends-shipLog",
                            "[Nancy (repair crew member)] Our jump drive needs help. My brother on %s fixes jump drives and he could get ours working"
                        ),
                        jumpFixStation:getCallSign()
                    ),
                    "Magenta"
                )
            ...
            if reactorFixStationMessage == nil then
                playerRepulse:addToShipLog(
                    string.format(
                        _(
                            "crewFriends-shipLog",
                            "[Manuel (repair crew member)] The reactor could use some tuning. My cousin can fix us up. He does work on reactors on %s"
                        ),
                        reactorFixStation:getCallSign()
                    ),
                    "Magenta"
                )
                ...
                if playerRepulse:hasPlayerAtPosition("Relay") then
                    if crewFixButtonMsg == nil then
                        ...
                        playerRepulse:addCustomButton(
                            "Relay",
                            crewFixButtonMsg,
                            _("crewRepairStatut-buttonRelay", "crew fixers"),
                            showCrewFixers
                        )
                    end
                end
                if playerRepulse:hasPlayerAtPosition("Operations") then
                    if crewFixButtonMsgOp == nil then
                        ...
                        playerRepulse:addCustomButton(
                            ...
                            crewFixButtonMsgOp,
                            _(
                                "crewRepairStatut-buttonOperations",
                                "crew fixers"
                            ),
                            showCrewFixers
                        )
    ...
    if harassment_timer < 0 then
        if playerRepulse:getReputationPoints() < 150 then
            ...
            total_health = total_health
                + playerRepulse:getSystemHealth("beamweapons")
            total_health = total_health
                + playerRepulse:getSystemHealth("maneuver")
            total_health = total_health
                + playerRepulse:getSystemHealth("missilesystem")
            total_health = total_health
                + playerRepulse:getSystemHealth("impulse")
            total_health = total_health
                + playerRepulse:getSystemHealth("jumpdrive")
            total_health = total_health
                + playerRepulse:getSystemHealth("frontshield")
            total_health = total_health
                + playerRepulse:getSystemHealth("rearshield")
            ...
            local dpx, dpy = vectorFromAngle(
                random(0, 360),
                playerRepulse:getLongRangeRadarRange() + 500
            )
            local fleet =
                spawnEnemies(cpx + dpx, cpy + dpy, total_health, "Exuari")
...
function showCrewFixers()
    ...
    if not playerRepulse.missileFix then
        oMsg = oMsg
            .. string.format(
                _("crewRepairStatut-msgRelay&Operations", " Missiles:%s(%s) "),
                missileFixStation:getCallSign(),
                missileFixStation:getSectorName()
            )
    end
    if not playerRepulse.frontShieldFix and not playerRepulse.rearShieldFix then
        oMsg = oMsg
            .. string.format(
                _("crewRepairStatut-msgRelay&Operations", " Shields:%s(%s) "),
                shieldFixStation:getCallSign(),
                shieldFixStation:getSectorName()
            )
    end
    if not playerRepulse.impulseFix then
        oMsg = oMsg
            .. string.format(
                _("crewRepairStatut-msgRelay&Operations", " Impulse:%s(%s) "),
                impulseFixStation:getCallSign(),
                impulseFixStation:getSectorName()
            )
    end
    if not playerRepulse.longRangeFix then
        oMsg = oMsg
            .. string.format(
                _(
                    "crewRepairStatut-msgRelay&Operations",
                    " Communications:%s(%s) "
                ),
                longRangeFixStation:getCallSign(),
                longRangeFixStation:getSectorName()
            )
    end
    if not playerRepulse.jumpFix then
        oMsg = oMsg
            .. string.format(
                _("crewRepairStatut-msgRelay&Operations", " Jump:%s(%s) "),
                jumpFixStation:getCallSign(),
                jumpFixStation:getSectorName()
            )
    end
    if not playerRepulse.reactorFix then
        oMsg = oMsg
            .. string.format(
                _("crewRepairStatut-msgRelay&Operations", " Reactor:%s(%s) "),
                reactorFixStation:getCallSign(),
                reactorFixStation:getSectorName()
            )
    end
    if oMsg == nil then
        if crewFixButtonMsg ~= nil then
        ...
        playerRepulse:addToShipLog(
            _(
                "crewRepair-shipLog",
                "Repair crew suggested locations for ship fixes:"
            ),
            "Magenta"
        )
        ...
        if beamFixStation == nil then
            repeat
                ...
                if
                    candidate ~= nil
                    and candidate:isValid()
                    and distance(candidate, playerRepulse) < 80000
                then
            ...
            playerRepulse:addToShipLog(
                string.format(
                    _(
                        "crewFriends-shipLog",
                        "[Kent (repair crew member)] My brother on %s in %s can fix our port side beam weapon"
                    ),
                    beamFixStation:getCallSign(),
                    beamFixStation:getSectorName()
                ),
                "Magenta"
            )
            plot2 = chaseTrigger
...
function junkYardDog(delta)
    ...
    if junkYardDogTimer < 0 then
        ...
        if
            playerRepulse.junk_yard_dog_warning == nil
            and junk_yard_dog ~= nil
            and junk_yard_dog:isValid()
        then
            playerRepulse:addToShipLog(
                string.format(
                    _(
                        "Boris-shipLog",
                        "[Sensor tech] Looks like %s figured out where we went and has sicced %s on us."
                    ),
                    brigStation:getCallSign(),
                    junk_yard_dog:getCallSign()
                ),
                "Magenta"
            )
            playerRepulse:addToShipLog(
                string.format(
                    _(
                        "Boris-shipLog",
                        "[Engineering tech] With our hull at %i, we better hope our shields hold"
                    ),
                    playerRepulse:getHull()
                ),
                "Magenta"
            )
    ...
    if borisChaseTimer < 0 then
        ...
        if not junkZone:isInside(playerRepulse) then
            if junkChaser ~= nil and junkChaser:isValid() then
                if
                    boris_message_log_messages == nil
                    or #boris_message_log_messages == 0
                then
                    boris_message_log_messages = {
                        _(
                            "Boris-shipLog",
                            "[%s] You won't get away so easily."
                        ),
                        _(
                            "Boris-shipLog",
                        ...
                        _(
                            "Boris-shipLog",
                            "[%s] I will hunt you down and destroy you like vermin."
                        ),
                        _(
                            "Boris-shipLog",
                            "[%s] Slow down, I promise not to destroy you immediately."
                        ),
                    }
                end
                local chaser_message =
                    tableRemoveRandom(boris_message_log_messages)
                playerRepulse:addToShipLog(
                    string.format(chaser_message, junkChaser:getCallSign()),
                    "Red"
                )
            else
                if difficulty < 1 then
                ...
                if
                    boris_comms_messages == nil
                    or #boris_comms_messages == 0
                then
                    boris_comms_messages = {
                        _(
                            "Boris-incCall",
                            "You don't steal from Boris Junk Yard without consequences. I'm coming for you."
                        ),
                        _(
                            "Boris-incCall",
                            "I saw you steal that ship. You'll rue the day."
                        ),
                        _(
                            "Boris-incCall",
                            "Stealing a ship, eh? We'll just see about that."
                        ),
                        _(
                            "Boris-incCall",
                            "You must pay for the ship you stole from Boris Junk Yard... with your life."
                        ),
                    }
                end
...
function resetBoris(self, instigator)
    ...
    playerRepulse:addToShipLog(
        string.format(boris_expiration_message, self:getCallSign()),
        "Red"
    )
end
------------------------------------
...
function jumpPartRecognition(delta)
    ...
    if jumpPartRecognitionTimer < 0 then
        playerRepulse:addToShipLog(
            _(
                "crewRepair-shipLog",
                "Repair crew thinks they can use the space debris recently acquired to make repair parts for the jump drive. They are starting the fabrication process now."
            ),
            "Magenta"
        )
        plot3 = jumpPartFabrication
...
function jumpPartFabrication(delta)
    ...
    if jumpPartFabricationTimer < 0 then
        playerRepulse:addToShipLog(
            _(
                "crewRepair-shipLog",
                "Repair crew finished jump drive part fabrication. They believe the jump drive should be functional soon."
            ),
            "Magenta"
        )
        playerRepulse:setSystemHealthMax("jumpdrive", 0.5)
        plot3 = nil
    end
end
-------------------------------
...
function returnHome(delta)
    for i = 1, #friendlyStationList do
        if
            friendlyStationList[i] ~= nil and friendlyStationList[i]:isValid()
        then
            if playerRepulse:isDocked(friendlyStationList[i]) then
                globalMessage(
                    _(
                        "victory-msgMainscreen",
                        "Congratulations! You escaped the Kraylor clutches and returned all your gathered data on the Kraylor to the Human Navy."
                    )
                )
                victory("Human Navy")
            end
...
function kraylorPatrol(delta)
    ...
    if kraylorPatrolSpawnDelay < 0 then
        ...
        if
            playerRepulse ~= nil
            and playerRepulse:isValid()
            and playerRepulse:getFaction() == "Human Navy"
        then
            kraylorAlerted = true
        ...
        if kraylorPatrolCount < patrolLimit then
            ...
            if
                kraylorAlerted
                and kraylorPatrolCount / patrolLimit * 100 < random(1, 100)
            then
                nearFriend, rest =
                    nearStations(playerRepulse, friendlyStationList)
                nfx, nfy = nearFriend:getPosition()
                plx, ply = playerRepulse:getPosition()
                patrolGroup = spawnEnemies(
                    (nfx + plx) / 2,
                    (nfy + ply) / 2,
                    random(0.8, 1.2),
                    "Kraylor"
                ...
                patrolGroup =
                    spawnEnemies(tx + dx, ty + dy, random(0.8, 2.2), "Kraylor")
            end
            kGroup = kGroup + 1
        ...
        for tidx, obj in ipairs(independentTransportList) do
            if obj:isValid() then
                ...
                if obj.target ~= nil and obj.target:isValid() then
                    ...
                    obj.target =
                        randomNearStation(math.random(4, 8), obj, stationList)
                    obj.undock_delay = math.random(1, 4)
                    obj:orderDock(obj.target)
                end
            else
                invalidIndependentTransportCount = invalidIndependentTransportCount
                    + 1
            end
        end
    ...
    for system, health in pairs(scrag_system_health) do
        if health.max ~= nil then
            if playerFighter ~= nil and playerFighter:isValid() then
                if
                    playerFighter:getSystemHealth(system)
                    >= playerFighter:getSystemHealthMax(system)
                then
                    ...
                    if playerFighter.repair_max_msg_eng[system] == nil then
                        playerFighter.repair_max_msg_eng[system] =
                            string.format("repair_max_msg_eng_%s", system)
                        playerFighter:addCustomMessage(
                            "Engineering",
                            playerFighter.repair_max_msg_eng[system],
                            health.msg
                    ...
                    if playerFighter.repair_max_msg_epl[system] == nil then
                        playerFighter.repair_max_msg_epl[system] =
                            string.format("repair_max_msg_epl_%s", system)
                        playerFighter:addCustomMessage(
                            "Engineering+",
                            playerFighter.repair_max_msg_epl[system],
                            health.msg
            ...
            if playerRepulse ~= nil and playerRepulse:isValid() then
                ...
                then
                    ...
                    if playerRepulse.repair_max_msg_eng[system] == nil then
                        playerRepulse.repair_max_msg_eng[system] =
                            string.format("repair_max_msg_eng_%s", system)
                        playerRepulse:addCustomMessage(
                            "Engineering",
                            playerRepulse.repair_max_msg_eng[system],
                            health.msg
                        )
                    ...
                    if playerRepulse.repair_max_msg_epl[system] == nil then
                        playerRepulse.repair_max_msg_epl[system] =
                            string.format("repair_max_msg_epl_%s", system)
                        playerRepulse:addCustomMessage(
                            "Engineering+",
                            playerRepulse.repair_max_msg_epl[system],
...
function update(delta)
    ...
    stationWig
        :setPosition(bwx + bobsx, bwy + bobsy)
        :setRotation(stationWig.angle)
    stationWig.angle = stationWig.angle + 0.02
    malx, maly = vectorFromAngle(stationMal.angle, 3000)
    stationMal:setPosition(msx + malx, msy + maly):setRotation(stationMal.angle)
    stationMal.angle = stationMal.angle + 0.05
