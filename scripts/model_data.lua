...
for idx, color in ipairs({"Red", "Green", "Blue", "Orange", "Purple"}) do
    model = ModelData()
    model:setName("Imperial_" .. color)
    model:setMesh("mesh/ship/Quaternius/Imperial.obj")
    model:setTexture("mesh/ship/Quaternius/Imperial_" .. color .. ".png")
    model:setScale(1)
    model:setRadius(200)
    model:setCollisionBox(400, 175)
    model:addBeamPosition(4.9, 0, 29.5)
    model:addTubePosition(88.75, -56.0, 5.8)
    model:addTubePosition(88.75,  56.0, 5.8)
    model:addEngineEmitter(-157.8,     0, -1.0, 1.0, 0.4, 0.4, 42.0)
    model:addEngineEmitter(-167.9, -62.7, -1.6, 1.0, 0.4, 0.4, 16.0)
    model:addEngineEmitter(-167.9,  62.7, -1.6, 1.0, 0.4, 0.4, 16.0)

    model = ModelData()
    model:setName("Insurgent_" .. color)
    model:setMesh("mesh/ship/Quaternius/Insurgent.obj")
    model:setTexture("mesh/ship/Quaternius/Insurgent_" .. color .. ".png")
    model:setScale(1)
    model:setRadius(175)
    model:setCollisionBox(350, 175)
    model:addBeamPosition( 66.7, -0.05, 13.2)
    model:addBeamPosition( 66.7, -20.1, 23.3)
    model:addBeamPosition( 66.7,  20.1, 23.3)
    model:addBeamPosition(104,     0,   45)
    model:addTubePosition(61.9, -28.5, -0.5)
    model:addTubePosition(61.9,  28.5, -0.5)
    model:addEngineEmitter(-142.5, -24.6,  7.0, 1.0, 0.4, 0.4, 30.0)
    model:addEngineEmitter(-142.5,  24.6,  7.0, 1.0, 0.4, 0.4, 30.0)
    model:addEngineEmitter(-146.1, -50.6, 23.4, 1.0, 0.4, 0.4, 10.0)
    model:addEngineEmitter(-146.1,  50.6, 23.4, 1.0, 0.4, 0.4, 10.0)
    model:addEngineEmitter(-132.8, -73.6, -2.5, 1.0, 0.4, 0.4, 19.0)
    model:addEngineEmitter(-132.8,  73.6, -2.5, 1.0, 0.4, 0.4, 19.0)
end
...
model=ModelData():setName("astroid_1"):setScale(100):setRadius(100):setMesh("Astroid_1.model"):setTexture("Astroid_1_d.png"):setSpecular("Astroid_1_s.png"):setNormalMap("Astroid_1_n.png")
model=ModelData():setName("astroid_2"):setScale(100):setRadius(100):setMesh("Astroid_2.model"):setTexture("Astroid_2_d.png"):setSpecular("Astroid_2_s.png"):setNormalMap("Astroid_2_n.png")
model=ModelData():setName("astroid_3"):setScale(100):setRadius(100):setMesh("Astroid_3.model"):setTexture("Astroid_3_d.png"):setSpecular("Astroid_3_s.png"):setNormalMap("Astroid_3_n.png")
model=ModelData():setName("astroid_4"):setScale(100):setRadius(100):setMesh("Astroid_4.model"):setTexture("Astroid_4_d.png"):setSpecular("Astroid_4_s.png"):setNormalMap("Astroid_4_n.png")
model=ModelData():setName("astroid_5"):setScale(100):setRadius(100):setMesh("Astroid_5.model"):setTexture("Astroid_5_d.png"):setSpecular("Astroid_5_s.png"):setNormalMap("Astroid_5_n.png")
model=ModelData():setName("astroid_6"):setScale(100):setRadius(100):setMesh("Astroid_6.model"):setTexture("Astroid_6_d.png"):setSpecular("Astroid_6_s.png"):setNormalMap("Astroid_6_n.png")
model=ModelData():setName("astroid_7"):setScale(100):setRadius(100):setMesh("Astroid_7.model"):setTexture("Astroid_7_d.png"):setSpecular("Astroid_7_s.png"):setNormalMap("Astroid_7_n.png")
model=ModelData():setName("astroid_8"):setScale(100):setRadius(100):setMesh("Astroid_8.model"):setTexture("Astroid_8_d.png"):setSpecular("Astroid_8_s.png"):setNormalMap("Astroid_8_n.png")
model=ModelData():setName("astroid_9"):setScale(100):setRadius(100):setMesh("Astroid_9.model"):setTexture("Astroid_9_d.png"):setSpecular("Astroid_9_s.png"):setNormalMap("Astroid_9_n.png")
model=ModelData():setName("astroid_10"):setScale(100):setRadius(100):setMesh("Astroid_10.model"):setTexture("Astroid_10_d.png"):setSpecular("Astroid_10_s.png"):setNormalMap("Astroid_10_n.png")
