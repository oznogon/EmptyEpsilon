...
model:addMountPosition(0, 23, 0, -1.8)
...
model:setRadius(100)
-- Visual positions of the mounts (blender: -X, Y, Z). Type: 0=BeamWeapon, 1=MissileWeapon
model:addMountPosition(0, -1.6, -8, -2)
model:addMountPosition(0, -1.6, 8, -2)
model:addMountPosition(1, 18, 0, -3.5)
model:addMountPosition(1, 18, 0, -3.5)
...
model:setRadius(100)
-- Visual positions of the mounts (blender: -X, Y, Z). Type: 0=BeamWeapon, 1=MissileWeapon
model:addMountPosition(1, 2, -10, -2.3)
model:addMountPosition(1, 2, 10, -2.3)
model:addEngineEmitter(-13, -2.1500, 0.3, 0.2, 0.2, 1.0, 3.0)
model:addEngineEmitter(-13, 2.1500, 0.3, 0.2, 0.2, 1.0, 3.0)
...
model:setRadius(200)
-- Visual positions of the mounts (blender: -X, Y, Z). Type: 0=BeamWeapon, 1=MissileWeapon
model:addMountPosition(0, 34, -17, -7)
model:addMountPosition(0, 34, 17, -7)
model:addMountPosition(0, -5, -33, -1)
model:addMountPosition(0, -5, 33, -1)
model:addMountPosition(1, 5, -7, -11)
model:addMountPosition(1, 5, 7, -11)
...
model:setRadius(200)
-- Visual positions of the mounts (blender: -X, Y, Z). Type: 0=BeamWeapon, 1=MissileWeapon
model:addMountPosition(0, 37, -14.5, -3.5)
model:addMountPosition(0, 37, 14.5, -3.5)
model:addMountPosition(0, 10, -12, -15)
model:addMountPosition(0, 10, 12, -15)
model:addMountPosition(0, -9, -28, -3)
model:addMountPosition(0, -9, 28, -3)
...
model:setRadius(200)
-- Visual positions of the mounts (blender: -X, Y, Z). Type: 0=BeamWeapon, 1=MissileWeapon
model:addMountPosition(0, 22, 22, -4.5)
model:addMountPosition(0, 22, -22, -4.5)
model:addMountPosition(0, 12, 22, -4.5)
model:addMountPosition(0, 12, -22, -4.5)
...
model:setRadius(200)
-- Visual positions of the mounts (blender: -X, Y, Z). Type: 0=BeamWeapon, 1=MissileWeapon
model:addMountPosition(0, 4, -27, -0.5)
model:addMountPosition(0, 4, 27, -0.5)
model:addMountPosition(1, 30, -11, -0.5)
model:addMountPosition(1, 30, 11, -0.5)
...
-- Visual positions of the mounts (blender: -X, Y, Z). Type: 0=BeamWeapon, 1=MissileWeapon
model:addMountPosition(0, -2, -31, -0.5)
model:addMountPosition(0, -2, 31, -0.5)
model:addMountPosition(1, 27, 0, -0.5)
model:addMountPosition(1, 27, 0, -0.5)
...
-- Visual positions of the mounts (blender: -X, Y, Z). Type: 0=BeamWeapon, 1=MissileWeapon
model:addMountPosition(0, 66, -71, 12)
model:addMountPosition(0, 66, -71, -12)
model:addMountPosition(0, 66, 71, 12)
model:addMountPosition(0, 66, 71, -12)
model:addMountPosition(0, -32, -71, 12)
model:addMountPosition(0, -32, -71, -12)
model:addMountPosition(0, -32, 71, 12)
model:addMountPosition(0, -32, 71, -12)
model:addMountPosition(0, -112, -71, 12)
model:addMountPosition(0, -112, -71, -12)
model:addMountPosition(0, -112, 71, 12)
model:addMountPosition(0, -112, 71, -12)
...
for idx, color in ipairs({ "Blue", "Green", "Grey", "Red", "White", "Yellow" }) do
    ...
    model:setTexture(
        "AdlerLongRangeScout/AlbedoAO/AdlerLongRangeScout"
            .. color
            .. "AlbedoAO.png"
    )
    ...
    model:setRadius(30)
    -- Visual positions of the mounts (blender: -X, Y, Z). Type: 0=BeamWeapon, 1=MissileWeapon
    model:addMountPosition(0, 1.8, 0, 0.03)
    model:addMountPosition(0, 1.8, 0.13, 0.03)
    model:addMountPosition(0, 1.8, -0.13, 0.03)
    model:addMountPosition(1, 1.8, 0, 0.03)
    ...
    model:setTexture(
        "AtlasHeavyFighter/AlbedoAO/AtlasHeavyFighter"
            .. color
            .. "AlbedoAO.png"
    )
    ...
    -- Visual positions of the mounts (blender: -X, Y, Z). Type: 0=BeamWeapon, 1=MissileWeapon
    model:addMountPosition(0, 2.4, 0.1, -0.25)
    model:addMountPosition(0, 2.4, -0.1, -0.25)
    model:addMountPosition(1, 1, 0.4, 0)
    model:addMountPosition(1, 1, -0.4, 0)
    model:addMountPosition(1, -1, 0, 0) --Mine tube
    ...
    model:setTexture(
        "LindwurmFighter/AlbedoAO/LindwurmFighter" .. color .. "AlbedoAO.png"
    )
    ...
    model:addMountPosition(1, 0.3, 0.5, 0.06)
    model:addMountPosition(1, 0.3, -0.5, 0.06)
    ...
    model:setTexture(
        "WespeScout/AlbedoAO/WespeScout" .. color .. "AlbedoAO.png"
    )
    ...
    model:setTexture(
        "HeavyCorvette/AlbedoAO/HeavyCorvette" .. color .. "AlbedoAO.png"
    )
    ...
    model:setTexture(
        "LaserCorvette/AlbedoAO/LaserCorvette" .. color .. "AlbedoAO.png"
    )
    ...
    model:setTexture(
        "LightCorvette/AlbedoAO/LightCorvette" .. color .. "AlbedoAO.png"
    )
    ...
    model:setTexture(
        "MineLayerCorvette/AlbedoAO/MineLayerCorvette"
            .. color
            .. "AlbedoAO.png"
    )
    ...
    model:setTexture(
        "MissileCorvette/AlbedoAO/MissileCorvette" .. color .. "AlbedoAO.png"
    )
    ...
    model:setTexture(
        "MultiGunCorvette/AlbedoAO/MultiGunCorvette" .. color .. "AlbedoAO.png"
    )
...
ModelData()
    ...
    :setScale(3)
    :setRadius(50)
    :setMesh("mesh/Artifact1.obj")
    :setTexture("texture/electric_sphere_texture.png")
ModelData()
    :setName("artifact2")
    :setScale(3)
    :setRadius(50)
    :setMesh("mesh/Artifact2.obj")
    :setTexture("texture/electric_sphere_texture.png")
ModelData()
    :setName("artifact3")
    :setScale(3)
    :setRadius(50)
    :setMesh("mesh/Artifact3.obj")
    :setTexture("texture/electric_sphere_texture.png")
ModelData()
    :setName("artifact4")
    :setScale(3)
    :setRadius(50)
    :setMesh("mesh/Artifact4.obj")
    :setTexture("texture/electric_sphere_texture.png")
ModelData()
    :setName("artifact5")
    :setScale(3)
    :setRadius(50)
    :setMesh("mesh/Artifact5.obj")
    :setTexture("texture/electric_sphere_texture.png")
ModelData()
    :setName("artifact6")
    :setScale(3)
    :setRadius(50)
    :setMesh("mesh/Artifact6.obj")
    :setTexture("texture/electric_sphere_texture.png")
ModelData()
    :setName("artifact7")
    :setScale(3)
    :setRadius(50)
    :setMesh("mesh/Artifact7.obj")
    :setTexture("texture/electric_sphere_texture.png")
ModelData()
    :setName("artifact8")
    :setScale(3)
    :setRadius(50)
    :setMesh("mesh/Artifact8.obj")
    :setTexture("texture/electric_sphere_texture.png")
...
model:addEngineEmitter(0.7, -0.35, 0, 0.2, 0.2, 0.7, 0.5)
model:addEngineEmitter(0.7, 0.35, 0, 0.2, 0.2, 0.7, 0.5)
...
model:setRadius(55)
-- Visual positions of the mounts (blender: -X, Y, Z). Type: 0=BeamWeapon, 1=MissileWeapon
model:addMountPosition(0, 2.7, -0.5, 0)
model:addMountPosition(0, 2.7, 0.5, 0)
model:addEngineEmitter(-1.5, -0.4, 0, 0.2, 0.2, 0.7, 0.5)
model:addEngineEmitter(-1.5, 0.4, 0, 0.2, 0.2, 0.7, 0.5)
...
model = ModelData()
    ...
    :setScale(100)
    :setRadius(100)
    :setMesh("Astroid_1.model")
    :setTexture("Astroid_1_d.png")
    :setSpecular("Astroid_1_s.png")
    :setNormalMap("Astroid_1_n.png")
model = ModelData()
    :setName("astroid_2")
    :setScale(100)
    :setRadius(100)
    :setMesh("Astroid_2.model")
    :setTexture("Astroid_2_d.png")
    :setSpecular("Astroid_2_s.png")
    :setNormalMap("Astroid_2_n.png")
model = ModelData()
    :setName("astroid_3")
    :setScale(100)
    :setRadius(100)
    :setMesh("Astroid_3.model")
    :setTexture("Astroid_3_d.png")
    :setSpecular("Astroid_3_s.png")
    :setNormalMap("Astroid_3_n.png")
model = ModelData()
    :setName("astroid_4")
    :setScale(100)
    :setRadius(100)
    :setMesh("Astroid_4.model")
    :setTexture("Astroid_4_d.png")
    :setSpecular("Astroid_4_s.png")
    :setNormalMap("Astroid_4_n.png")
model = ModelData()
    :setName("astroid_5")
    :setScale(100)
    :setRadius(100)
    :setMesh("Astroid_5.model")
    :setTexture("Astroid_5_d.png")
    :setSpecular("Astroid_5_s.png")
    :setNormalMap("Astroid_5_n.png")
model = ModelData()
    :setName("astroid_6")
    :setScale(100)
    :setRadius(100)
    :setMesh("Astroid_6.model")
    :setTexture("Astroid_6_d.png")
    :setSpecular("Astroid_6_s.png")
    :setNormalMap("Astroid_6_n.png")
model = ModelData()
    :setName("astroid_7")
    :setScale(100)
    :setRadius(100)
    :setMesh("Astroid_7.model")
    :setTexture("Astroid_7_d.png")
    :setSpecular("Astroid_7_s.png")
    :setNormalMap("Astroid_7_n.png")
model = ModelData()
    :setName("astroid_8")
    :setScale(100)
    :setRadius(100)
    :setMesh("Astroid_8.model")
    :setTexture("Astroid_8_d.png")
    :setSpecular("Astroid_8_s.png")
    :setNormalMap("Astroid_8_n.png")
model = ModelData()
    :setName("astroid_9")
    :setScale(100)
    :setRadius(100)
    :setMesh("Astroid_9.model")
    :setTexture("Astroid_9_d.png")
    :setSpecular("Astroid_9_s.png")
    :setNormalMap("Astroid_9_n.png")
model = ModelData()
    :setName("astroid_10")
    :setScale(100)
    :setRadius(100)
    :setMesh("Astroid_10.model")
    :setTexture("Astroid_10_d.png")
    :setSpecular("Astroid_10_s.png")
    :setNormalMap("Astroid_10_n.png")
