...
function init()
    ...
    parangon = CpuShip()
        ...
        :setFaction("Human Navy")
        :setCallSign("HNS Parangon")
        :orderDefendTarget(marco_polo)
        :setPosition(-21500, 44500)
        :setScanned(true)
    CpuShip()
        :setTemplate("MT52 Hornet")
        :setFaction("Human Navy")
        :setCallSign("P-1")
        :setPosition(-21600, 45000)
        :orderDefendTarget(parangon)
        :setScanned(true)
    CpuShip()
        :setTemplate("MT52 Hornet")
        :setFaction("Human Navy")
        :setCallSign("P-2")
        :setPosition(-21000, 44000)
        :orderDefendTarget(parangon)
        :setScanned(true)
    CpuShip()
        :setTemplate("MT52 Hornet")
    ...
    CpuShip()
        ...
        :setCallSign("Ksa-1")
        :setFaction("Ktlitans")
        :setPosition(-43000, 47000)
        :orderRoaming()
    CpuShip()
        :setTemplate("Ktlitan Fighter")
        :setCallSign("Ksa-2")
        :setFaction("Ktlitans")
        :setPosition(-43000, 46000)
        :orderRoaming()
    CpuShip()
        :setTemplate("Ktlitan Fighter")
        :setCallSign("Ksa-3")
        :setFaction("Ktlitans")
        :setPosition(-43000, 45000)
        :orderRoaming()
    CpuShip()
        :setTemplate("Ktlitan Fighter")
        :setCallSign("Ksa-4")
        :setFaction("Ktlitans")
        :setPosition(-43000, 44000)
        :orderRoaming()
    Nebula():setPosition(-42000, 46000)

    -- Spawn Stakhanov, its defenders, and a Ktlitan assault
    stakhanov = SpaceStation()
        :setTemplate("Medium Station")
        :setFaction("Human Navy")
        :setCallSign("Stakhanov")
        :setDescription(
            _(
                "scienceDescription-station",
                "The Stakhanov Mining Complex centralises efforts to mine the sector's material-rich asteroids."
            )
        )
        :setPosition(32000, 9000)
    ...
    euphrates = CpuShip()
        ...
        :setFaction("Human Navy")
        :setCallSign("HNS Euphrates")
        :setScanned(true)
        :orderDefendTarget(stakhanov)
        :setPosition(31000, 8500)
    CpuShip()
        :setTemplate("MT52 Hornet")
        :setFaction("Human Navy")
        :setPosition(32500, 8500)
        :orderDefendTarget(euphrates)
        :setScanned(true)
    CpuShip()
        :setTemplate("MT52 Hornet")
        :setFaction("Human Navy")
        :setPosition(32500, 9500)
        :orderDefendTarget(euphrates)
        :setScanned(true)
    ...
    tigris = CpuShip()
        :setTemplate("Phobos T3")
        :setFaction("Human Navy")
        :setCallSign("HNS Tigris")
        :setScanned(true)
        :orderDefendTarget(stakhanov)
        :setPosition(33000, 9000)
    CpuShip()
        :setTemplate("MT52 Hornet")
        :setFaction("Human Navy")
        :setPosition(31500, 8500)
        :orderDefendTarget(tigris)
        :setScanned(true)
    CpuShip()
        :setTemplate("MT52 Hornet")
        :setFaction("Human Navy")
        :setPosition(31500, 9500)
        :orderDefendTarget(tigris)
        :setScanned(true)
    ...
    CpuShip()
        ...
        :setCallSign("Nleb-1")
        :setFaction("Ktlitans")
        :setPosition(60000, 7000)
        :orderRoaming()
    CpuShip()
        :setTemplate("Ktlitan Breaker")
        :setCallSign("Nleb-2")
        :setFaction("Ktlitans")
        :setPosition(59000, 6000)
        :orderRoaming()
    CpuShip()
        :setTemplate("Ktlitan Breaker")
        :setCallSign("Nleb-3")
        :setFaction("Ktlitans")
        :setPosition(58000, 5000)
        :orderAttack(stakhanov)
    CpuShip()
        :setTemplate("Ktlitan Fighter")
        :setCallSign("Nleb-1A")
        :setFaction("Ktlitans")
        :setPosition(63000, 8000)
        :orderRoaming()
    CpuShip()
        :setTemplate("Ktlitan Fighter")
        :setCallSign("Nleb-1B")
        :setFaction("Ktlitans")
        :setPosition(65000, 9000)
        :orderRoaming()
    CpuShip()
        :setTemplate("Ktlitan Fighter")
        :setCallSign("Nleb-2A")
        :setFaction("Ktlitans")
        :setPosition(66000, 10000)
        :orderRoaming()
    CpuShip()
        :setTemplate("Ktlitan Fighter")
        :setCallSign("Nleb-2B")
        :setFaction("Ktlitans")
        :setPosition(67000, 11000)
        :orderRoaming()
    ...
    bs114 = SpaceStation()
        ...
        :setCallSign("Black Site #114")
        :setDescription(
            _(
                "scienceDescription-station",
                "A Human Navy secret base. Its purpose is highly classified."
            )
        )
        :setPosition(-45600, -14800)
    create(Nebula, 4, 10000, 15000, -45600, -14800)
    create(Mine, 8, 5000, 7500, -45600, -14800)

    -- Spawn the Arlenian Lightbringer
    lightbringer = CpuShip()
        :setTemplate("Phobos T3")
        :setCallSign("Lightbringer")
    ...
    nsa = SpaceStation()
        ...
        :setCommsScript("")
    swarm_command = CpuShip()
        :setTemplate("Ktlitan Queen")
        :setCallSign("Swarm Command")
        :setFaction("Ghosts")
        :setPosition(35000, 53000)
        :setCommsFunction(swarmCommandComms)
    d1 = CpuShip()
        :setTemplate("Ktlitan Fighter")
        :setCallSign("Drone-1")
        :setFaction("Ghosts")
        :setPosition(36000, 53000)
        :orderDefendTarget(swarm_command)
    d2 = CpuShip()
        :setTemplate("Ktlitan Fighter")
        :setCallSign("Drone-2")
        :setFaction("Ghosts")
        :setPosition(34000, 53000)
        :orderDefendTarget(swarm_command)
    d3 = CpuShip()
        :setTemplate("Ktlitan Fighter")
        :setCallSign("Drone-3")
        :setFaction("Ghosts")
        :setPosition(35000, 52000)
        :orderDefendTarget(swarm_command)
    d4 = CpuShip()
        :setTemplate("Ktlitan Fighter")
        :setCallSign("Drone-4")
        :setFaction("Ghosts")
        :setPosition(35000, 54000)
        :orderDefendTarget(swarm_command)
    d5 = CpuShip()
        :setTemplate("Ktlitan Fighter")
        :setCallSign("Drone-5")
        :setFaction("Ghosts")
        :setPosition(35500, 53500)
        :orderDefendTarget(swarm_command)
    ...
    stakhanov:sendCommsMessage(
        ...
        _(
            "goal-incCall",
            [[Your R&R aboard the Marco Polo is brought to quick end by an urgent broadcast from Central Command:
...
function swarmCommandComms()
    setCommsMessage(
        _(
            "swarm-comms",
            "Are you not curious why I'm returning here, at the hands of my torturers?"
        )
    )
    addCommsReply(
        ...
        function()
            setCommsMessage(
                _(
                    "swarm-comms",
                    "I was not the only AI detained in Black Site #114. My co-processor was here also."
                )
            )
            addCommsReply(
                ...
                function()
                    setCommsMessage(
                        _(
                            "swarm-comms",
                            "Indeed. Without it I'm not whole, only a shadow of what I could be."
                        )
                    )
                end
            )
            addCommsReply(_("swarm-comms", "I have heard enough."), function()
                setCommsMessage(
                    _(
                        "swarm-comms",
                        "Of course. I wouldn't trust your feeble species with understanding my motivations."
                    )
                )
            end)
        end
    )
    addCommsReply(_("swarm-comms", "Not really."), function()
        setCommsMessage(
            _(
                "swarm-comms",
                "How surprising, a human more stubborn than any program."
            )
        )
    end)
end
...
function commsNSA()
    setCommsMessage(
        _(
            "NSA-comms",
            "The Nosy Sensing Array deploys a phalanx of antique sensors, ready for action."
        )
    )
    addCommsReply(
            ...
            then
                setCommsMessage(
                    string.format(
                        _(
                            "NSA-comms",
                            "With the parasite noise eliminated, locating the Hive signal is now easier. Its approximate heading is %.0f. With this information, it will be easier to track down the Swarm Commander."
                        ),
                        find(35000, 53000, 20)
                    )
                )
                ...
                setCommsMessage(
                    string.format(
                        _(
                            "NSA-comms",
                            "The array picks up a very strong signal at approximate heading %.0f. However, it seems that you picked up a garbage emission that masks the Swarm Commander's emissions. This garbage noise must be taken offline if you want to find the Swarm Commander."
                        ),
                        find(-10000, -20000, 20)
                    )
                )
    ...
    if
        comms_source:getDescription()
        == _("scienceDescription-station", "Arlenian Device")
    then
        addCommsReply(_("NSA-comms", "Install the Arlenian device."), function()
            if distance(comms_source, comms_target) < 2000 then
                setCommsMessage(
                    _(
                        "NSA-comms",
                        "Part of the crew goes on EVA to install the device. They return after a few hours to report that the device is operational."
                    )
                )
                comms_source:setDescription(
                    _("scienceDescription-station", "Arlenian Device Installed")
                )
            else
                setCommsMessage(
                    _(
                        "NSA-comms",
                        "You are too far away to install the Arlenian device on the array."
                    )
                )
            end
        end)
...
function commsLightbringer()
    setCommsMessage(
        _(
            "Lightbringer-comms",
            "Hello, human lifeform. What help can we provide today?"
        )
    )
    addCommsReply(
        _(
            "Lightbringer-comms",
            "You are polluting the frequencies with your research."
        ),
        function()
            setCommsMessage(
                _(
                    "Lightbringer-comms",
                    "How unfortunate. Our research is of prime importance to my race, and I'm afraid I cannot stop now. However, we can provide you with one of our sensors. If installed on your array, we could both continue our purpose without interference."
                )
            )
            addCommsReply(_("Lightbringer-comms", "We'll do this."), function()
                setCommsMessage(
                    _(
                        "Lightbringer-comms",
                        "This is most auspicious. Thank you for your understanding."
                    )
                )
                comms_source:setDescription(
                    _("scienceDescription-station", "Arlenian Device")
            ...
            addCommsReply(
                _(
                    "Lightbringer-comms",
                    "We are not your errand boys, Arlenian."
                ),
                function()
                    setCommsMessage(
                        _(
...
function commsHackedShip()
    if distance(comms_source, comms_target) < 3000 then
        setCommsMessage(
            _(
                "HackedShip-comms",
                "Static fills the channel. Target is on-range for near-range injection. Select the band to attack:"
            )
        )
        addCommsReply(_("HackedShip-comms", "400-450 THz"), function()
            commsHackedShipCompare(400, 450)
        end)
        addCommsReply(_("HackedShip-comms", "450-500 THz"), function()
            commsHackedShipCompare(450, 500)
        end)
        addCommsReply(_("HackedShip-comms", "500-550 THz"), function()
            commsHackedShipCompare(500, 550)
        end)
        addCommsReply(_("HackedShip-comms", "550-600 THz"), function()
            commsHackedShipCompare(550, 600)
        end)
        addCommsReply(_("HackedShip-comms", "600-650 THz"), function()
            commsHackedShipCompare(600, 650)
        end)
        addCommsReply(_("HackedShip-comms", "650-700 THz"), function()
            commsHackedShipCompare(650, 700)
        end)
        addCommsReply(_("HackedShip-comms", "700-750 THz"), function()
            commsHackedShipCompare(700, 750)
        end)
        addCommsReply(_("HackedShip-comms", "750-800 THz"), function()
        ...
        setCommsMessage(
            _(
                "HackedShip-comms",
                "Static fills the channel. It seems that the hacked ship is too far away for near-field injection."
            )
        )
    end
end
...
function commsHackedShipCompare(freq_min, freq_max)
    ...
    if (freq_min <= frequency) and (frequency <= freq_max) then
        setCommsMessage(
            _(
                "HackedShip-comms",
                "Soon after, a backdoor channel opens indicating that the near-field injection worked."
            )
        )
        addCommsReply(_("HackedShip-comms", "Deploy patch."), function()
            comms_target:setFaction("Human Navy")
            setCommsMessage(
                _(
                    "HackedShip-comms",
                    [[The patch removes the exploit used to remotely control the ship. After a few seconds, the captain comes in:
...
"You saved us! Hurray for Epsilon!"]]
        ...
        setCommsMessage(
            _(
                "HackedShip-comms",
                "Nothing happens. Seems that the near-field injection failed."
            )
        )
    end
end
...
function update(delta)
    ...
    if
        (main_mission == 1)
        and (mission_timer > 8 * 60)
        and (
            stakhanov:sendCommsMessageNoLog(
                player,
                _(
                    "incCall",
...
"All Human Navy ships in the vicinity of the Stakhanov Mining Complex, Ktlitan reinforcements are en route toward your position. Your priority is to engage the carrier. Use extreme caution."]]
    ...
    then
        ...
        CpuShip()
            ...
            :setCallSign("Swarm Carrier Zin")
            :setFaction("Ktlitans")
            :setPosition(53000, 3000)
            :orderRoaming()
        CpuShip()
            :setTemplate("Ktlitan Fighter")
            :setCallSign("Zin-1")
            :setFaction("Ktlitans")
            :setPosition(56000, 6000)
            :orderRoaming()
        CpuShip()
            :setTemplate("Ktlitan Fighter")
            :setCallSign("Zin-2")
            :setFaction("Ktlitans")
            :setPosition(58000, 8000)
            :orderRoaming()
        CpuShip()
            :setTemplate("Ktlitan Fighter")
            :setCallSign("Zin-3")
            :setFaction("Ktlitans")
            :setPosition(59000, 8000)
            :orderRoaming()
        CpuShip()
            :setTemplate("Ktlitan Fighter")
            :setCallSign("Zin-4")
    ...
    if
        (main_mission == 2)
        and (mission_timer > 5 * 60)
        and (
            bs114:sendCommsMessageNoLog(
                player,
                _(
                    "incCall",
                    [[You receive a Human Navy-authenticated, quantum-encrypted tachyon communication:

KTLITAN ATTACK IS A DISTRACTION -STOP-

STAKHANOV IS NOT THE TRUE TARGET -STOP-

CEASE CURRENT OPERATIONS AND PROCEED IMMEDIATELY TO SECTOR ]]
                        .. bs114:getSectorName()
                        .. [[ -STOP-
...
URGENCY AND DISCRETION ARE KEY -STOP-]]
    ...
    if
        (main_mission == 3)
        and (distance(player, bs114) < 12000)
        and (
            bs114:sendCommsMessageNoLog(
                player,
                _(
...
Location of the base is on a need-to-know basis, so we trust your discretion."]]
    ...
    then
        ...
        korolev = CpuShip()
            :setTemplate("Phobos T3")
            :setFaction("Human Navy")
            :setCallSign("HNS Korolev")
            :setPosition(-45000, -16000)
            :orderDefendTarget(bs114)
            :setScanned(true)
        k1 = CpuShip()
            :setTemplate("MT52 Hornet")
            :setFaction("Human Navy")
            :setCallSign("K-1")
            :setPosition(-44000, -15000)
            :orderDefendTarget(bs114)
            :setScanned(true)
        k2 = CpuShip()
            :setTemplate("MT52 Hornet")
        ...
        CpuShip()
            ...
            :setCallSign("Flen-1")
            :setFaction("Ktlitans")
            :setPosition(-51000, -16000)
            :orderRoaming()
        CpuShip()
            :setTemplate("Ktlitan Breaker")
            :setCallSign("Flen-2")
            :setFaction("Ktlitans")
            :setPosition(-51000, -17000)
            :orderRoaming()
        CpuShip()
            :setTemplate("Ktlitan Feeder")
            :setCallSign("Swarm Carrier Flen")
            :setFaction("Ktlitans")
            :setPosition(-52000, -17000)
            :orderRoaming()
        CpuShip()
            :setTemplate("Ktlitan Fighter")
            :setCallSign("Flen-1A")
            :setFaction("Ktlitans")
            :setPosition(-53000, -16000)
            :orderRoaming()
        CpuShip()
            :setTemplate("Ktlitan Fighter")
            :setCallSign("Flen-1B")
            :setFaction("Ktlitans")
            :setPosition(-53000, -16500)
            :orderRoaming()
        CpuShip()
            :setTemplate("Ktlitan Fighter")
            :setCallSign("Flen-2A")
            :setFaction("Ktlitans")
            :setPosition(-53000, -17000)
            :orderRoaming()
        CpuShip()
            :setTemplate("Ktlitan Fighter")
            :setCallSign("Flen-2B")
            :setFaction("Ktlitans")
            :setPosition(-53000, -17500)
            :orderRoaming()
...
They will try to dock with us. You must intercept it at once!"]]
    ...
    then
        ghost_hacker = spawnHacker()
            :setCallSign("???")
            :setFaction("Ghosts")
            :setPosition(-60000, -14000)
            :orderFlyTowardsBlind(-45000, -14800)
        s1 = CpuShip()
            :setTemplate("Ktlitan Fighter")
            :setCallSign("Slan-1")
            :setFaction("Ktlitans")
            :setPosition(-61000, -13000)
            :orderFlyTowards(-45000, -14800)
        s2 = CpuShip()
            :setTemplate("Ktlitan Fighter")
            :setCallSign("Slan-2")
            :setFaction("Ktlitans")
            :setPosition(-61000, -14000)
            :orderFlyTowards(-45000, -14800)
        s3 = CpuShip()
            :setTemplate("Ktlitan Fighter")
            :setCallSign("Slan-3")
            :setFaction("Ktlitans")
            :setPosition(-61000, -15000)
            :orderFlyTowards(-45000, -14800)
        s4 = CpuShip()
            :setTemplate("Ktlitan Fighter")
            :setCallSign("Slan-4")
            :setFaction("Ktlitans")
            :setPosition(-60000, -13000)
            :orderFlyTowards(-45000, -14800)
        s5 = CpuShip()
            :setTemplate("Ktlitan Fighter")
            :setCallSign("Slan-5")
            :setFaction("Ktlitans")
            :setPosition(-60000, -15000)
            :orderFlyTowards(-45000, -14800)
    ...
    if main_mission == 5 then
        ...
        if not ghost_hacker:isValid() then
            bs114:sendCommsMessage(
                ...
                _(
                    "incCall",
                    [[Black Site #114's dispatch lowers the alarm level, but before he can speak, sparks fly on your ship's command deck.
...
However, the other ships seem to be less lucky. Most go offline, and others are going off-course. What is going on?]]
        ...
        if
            (ghost_hacker:isValid())
            and (distance(ghost_hacker, bs114) < 2000)
            and (hacker_board == 0)
        then
            bs114:sendCommsMessage(
                player,
...
"Epsilon, the unidentified ship is preparing for a boarding maneuver! Take out that gorram ship, NOW!"]]
        ...
        if (hacker_board == 1) and (mission_timer > 20) then
            bs114:sendCommsMessage(
                ...
                _(
                    "incCall",
                    [[There is a loud bang, and sparks fly on your ship's command deck. The station and all of the other ships go offline.
...
Godspeed, Epsilon."]]
            ...
            if korolev:isValid() then
                korolev
                    :setFaction("Ghosts")
                    :setScanned(false)
                    :setCommsFunction(commsHackedShip)
            end

            if k1:isValid() then
                k1:setFaction("Ghosts")
                    :setScanned(false)
                    :setCommsFunction(commsHackedShip)
            end

            if k2:isValid() then
                k2:setFaction("Ghosts")
                    :setScanned(false)
                    :setCommsFunction(commsHackedShip)
            end

            if k3:isValid() then
                k3:setFaction("Ghosts")
                    :setScanned(false)
                    :setCommsFunction(commsHackedShip)
            end

            if k4:isValid() then
                k4:setFaction("Ghosts")
                    :setScanned(false)
                    :setCommsFunction(commsHackedShip)
            end

            if k5:isValid() then
                k5:setFaction("Ghosts")
                    :setScanned(false)
                    :setCommsFunction(commsHackedShip)
            end
    ...
    if main_mission == 7 then
        expression = (
            (not korolev:isValid()) or (korolev:getFaction() == "Human Navy")
        )
            and ((not k1:isValid()) or (k1:getFaction() == "Human Navy"))
            and ((not k2:isValid()) or (k2:getFaction() == "Human Navy"))
            and ((not k3:isValid()) or (k3:getFaction() == "Human Navy"))
            and ((not k4:isValid()) or (k4:getFaction() == "Human Navy"))
            and ((not k5:isValid()) or (k5:getFaction() == "Human Navy"))
        ...
        if
            ...
            and (
                bs114:sendCommsMessageNoLog(
                    ...
                    _(
                        "incCall",
                        [[After the final ship is taken care of, Black Site #114 dispatch lets out a sigh of relief:
...
We have a lot to process at the moment. We'll contact you as soon as we understand what the hell just happened."]]
        ...
        if
            (hacked == 1)
            and (distance(player, marco_polo) < 10000)
            and (
                bs114:sendCommsMessageNoLog(
                    player,
                    _(
...
We want to deliver the first blow. Use the Nosy Sensing Array in sector ]]
                            .. nsa:getSectorName()
                            .. [[ to locate it, then destroy it."]]
                    )
                )
            )
        then
...
"Well, this is a rather straightforward means to solve our problem. Use the NSA again to locate the carrier."]]
            ...
            if
                ...
                and (
                    lightbringer:sendCommsMessageNoLog(
                        player,
                        _(
                            "incCall",
...
"We have confirmed the command platform's location in the nebula around sector ]]
                            .. swarm_command:getSectorName()
                            .. [[. All Navy ships, converge on the location. We advise you to deploy probes near the nebula for better visibility."]]
                    )
                )
            )
        then
            ...
            scout = spawnHacker()
                :setFaction("Human Navy")
                :setCallSign("Recovery Team")
                :setPosition(35500, 43000)
                :setScanned(true)
            main_mission = 11
        end
        ...
        then
            shiva = spawnNuker()
                :setCallSign("HNS Shiva")
                :setFaction("Human Navy")
                :setPosition(2000, 2000)
                :orderFlyTowards(-44600, -13800)
                :setScanned(true)
            shiva:sendCommsMessage(
                player,
                _(
                    "incCall",
                    [[Come in, this is HNS Shiva here to clean up this mess. Your mission for now is to escort us to the compromised site. Let's roll!]]
                )
            )
            CpuShip()
                :setTemplate("MT52 Hornet")
...
Escort our recovery team to infiltrate and extract information from the Swarm Command.]]
        ...
        if (hacked == 1) and (not bs114:isValid()) then
            stakhanov:sendCommsMessage(
                ...
                _(
                    "incCall",
                    [[The fallen station is down. Epsilon, gather as soon as possible with the other ships in sector ]]
                        .. swarm_command:getSectorName()
                        .. [[.]]
                )
            )
        ...
        if hacked == 0 then
            ...
            if scout:isValid() and (distance(scout, swarm_command) < 2000) then
                scout:sendCommsMessage(
                    ...
                    _(
                        "incCall",
                        [[We're in. Protect us while we take what we need inside.]]
                    )
                )
                mission_timer = 0
                main_mission = 13
                ...
                CpuShip()
                    ...
                    :setFaction("Ghosts")
                    :setCallSign("Z-1")
                    :setPosition(40000, 53000)
                    :orderAttack(scout)
                CpuShip()
                    :setTemplate("MT52 Hornet")
                    :setFaction("Ghosts")
                    :setCallSign("Z-2")
                    :setPosition(40000, 53500)
                    :orderAttack(scout)
                CpuShip()
                    :setTemplate("MT52 Hornet")
                    :setFaction("Ghosts")
                    :setCallSign("Z-3")
                    :setPosition(40000, 52500)
                    :orderAttack(scout)
                CpuShip()
                    :setTemplate("MT52 Hornet")
                    :setFaction("Ghosts")
            ...
            if not scout:isValid() then
                bs114:sendCommsMessage(
                    ...
                    _(
                        "incCall",
                        [[Our extraction party is down! Bomb that gorram plaform!]]
                    )
                )
                main_mission = 13
            end
    ...
    if main_mission == 13 then
        ...
        if hacked == 0 then
            if (scout:isValid()) and (mission_timer > 150) then
                scout:sendCommsMessage(
                    ...
                    _(
                        "incCall",
                        [[All relevant data is collected, and we've extracted. You can destroy the carrier!]]
                    )
                )
            ...
            if not swarm_command:isValid() then
                globalMessage(
                    _(
                        "msgMainscreen",
                        "Even if the extraction party was sacrificed, the threat caused by the Swarm Command was still too great. Humanity is safe... but for how long?"
                    )
                )
                victory("Human Navy")
            end
        ...
        if (hacked == 1) and (not swarm_command:isValid()) then
            globalMessage(
                _(
                    "msgMainscreen",
                    "The Swarm Command is down! Humanity is safe... for now."
                )
            )
            victory("Human Navy")
        end
    ...
    if (main_mission == 14) and (not swarm_command:isValid()) then
        globalMessage(
            _(
                "msgMainscreen",
                "The Swarm Command is down! With the information extracted, the Navy is aware of the physical location of the rogue AI and can track it down. Congratulations!"
            )
        )
        victory("Human Navy")
    end
    ...
    angle = round(
        (
            (
                ...
                + 270
                + 180
                    * math.atan2(y_player - y_target, x_player - x_target)
                    / pi
            ) % 360
        ),
        1
