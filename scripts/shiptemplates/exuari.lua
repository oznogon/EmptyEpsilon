...
local template = ShipTemplate()
    ...
    :setClass(_("class", "Exuari"), _("subclass", "Starfighter - Fighter"))
...
variation:setClass(
    _("class", "Exuari"),
    _("subclass", "Starfighter - Interceptor")
)
...
template = ShipTemplate()
    ...
    :setClass(_("class", "Exuari"), _("subclass", "Starfighter - Light Bomber"))
template:setModel("small_fighter_1")
template:setRadarTrace("exuari_fighter.png")
template:setDescription(
    _(
...
variation:setClass(
    _("class", "Exuari"),
    _("subclass", "Starfighter - Heavy Bomber")
)
variation:setDescription(
    _(
...
template = ShipTemplate()
    ...
    :setClass(_("class", "Exuari"), _("subclass", "Striker"))
...
template = ShipTemplate()
    ...
    :setClass(_("class", "Exuari"), _("subclass", "Frigate"))
...
template = ShipTemplate()
    ...
    :setClass(_("class", "Exuari"), _("subclass", "Artillery"))
...
template = ShipTemplate()
    ...
    :setClass(_("class", "Exuari"), _("subclass", "Carrier"))
