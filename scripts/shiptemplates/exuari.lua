...
--[[ Fighters --]]
-- Fighters are quick agile ships that do not do a lot of damage, but usually come in larger groups. They are easy to take out, but should not be underestimated.
local template = ShipTemplate():setName("Dagger"):setLocaleName(_("ship", "Dagger")):setClass(_("class", "Exuari"), _("subclass", "Starfighter - Fighter"))
...
template = ShipTemplate():setName("Gunner"):setLocaleName(_("ship", "Gunner")):setClass(_("class", "Exuari"), _("subclass", "Starfighter - Light Bomber"))
template:setModel("small_fighter_1")
template:setRadarTrace("exuari_fighter.png")
...
template = ShipTemplate():setName("Racer"):setLocaleName(_("ship", "Racer")):setClass(_("class", "Exuari"), _("subclass", "Striker"))
...
variation = template:copy("Hunter"):setLocaleName(_("ship", "Hunter"))
...
template = ShipTemplate():setName("Guard"):setLocaleName(_("ship", "Guard")):setClass(_("class", "Exuari"), _("subclass", "Frigate"))
...
template = ShipTemplate():setName("Sentinel"):setLocaleName(_("ship", "Sentinel")):setClass(_("class", "Exuari"), _("subclass", "Frigate"))
...
template = ShipTemplate():setName("Warden"):setLocaleName(_("ship", "Warden")):setClass(_("class", "Exuari"), _("subclass", "Frigate"))
...
variation = template:copy("Ranger"):setLocaleName(_("ship", "Ranger"))
...
template = ShipTemplate():setName("Ryder"):setLocaleName(_("ship", "Ryder")):setModel("Ender Battlecruiser"):setClass(_("class", "Exuari"), _("subclass", "Carrier"))
...
variation = template:copy("Fortress"):setLocaleName(_("ship", "Fortress"))
