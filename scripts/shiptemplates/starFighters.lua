...
local variation =
    template:copy("MU52 Hornet"):setLocaleName(_("ship", "MU52 Hornet"))
...
variation:setDescription(
    _(
        [[The ZX-Lindworm is a vastly improved version of the WX-Lindworm. Additional beam weapon, more missiles, tougher, faster and more agile.]]
    )
)
