...
local template = ShipTemplate()
    ...
    :setClass(_("class", "Corvette"), _("subclass", "Destroyer"))
...
template = ShipTemplate()
    ...
    :setClass(_("class", "Corvette"), _("subclass", "Popper"))
...
template = ShipTemplate()
    ...
    :setClass(_("class", "Corvette"), _("subclass", "Gunner"))
...
template = ShipTemplate()
    ...
    :setClass(_("class", "Corvette"), _("subclass", "Support"))
...
for cnt = 1, 5 do
    template = ShipTemplate()
        ...
        :setClass(_("class", "Corvette"), _("subclass", "Freighter"))
    ...
    if cnt > 2 then
        variation = template:copy("Goods Jump Freighter " .. cnt):setLocaleName(
    ...
    if cnt > 2 then
        variation = template:copy("Fuel Jump Freighter " .. cnt):setLocaleName(
...
template:setRadarTrace("transport.png")
template:setJumpDrive(true)
template:setJumpDriveRange(5000, 100 * 50000) -- The jump carrier can jump 100x farther then normal jump drives.
...
variation = template
    ...
    :setType("playership")
    :setClass(_("class", "Corvette"), _("subclass", "Freighter/Carrier"))
variation:setDescription(
    _(
...
template = ShipTemplate()
    ...
    :setType("playership")
    :setClass(_("class", "Corvette"), _("subclass", "Carrier"))
template:setDescription(
    _(
