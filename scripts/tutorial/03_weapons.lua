...
--- -To fire a missile, the Weapons officer presses a loaded missile tube. Except for HVLIs and HVPEs, missiles home in on any target selected by the Weapons officer. Otherwise, the missile is dumb-fired and flies in a straight line from its tube. The Weapons officer can choose to lock the tube's aim onto a target or click the Lock button to the top right of the radar to manually angle a shot.
---
--- Weapon Types:
--- Homing: 
...
--- -A group of 5 simple lead slugs fired in a single burst at high velocity. Compared to energy-weapon HVPEs, HVLIs are kinetic projectiles launched at a lower velocity and fire rate but are more effective at much longer ranges. These bolts don't home in on an enemy target.
--- High-Velocity Plasma Ejector (HVPE):
--- -A group of 5 blasts of ignited plasma fired in a single burst at high velocity. Compared to kinetic-weapon HVLIs, HVPEs are energy projectiles launched at a higher velocity and fire rate but dissipate at much shorter ranges. These bolts don't home in on an enemy target.
--- Mine: 
