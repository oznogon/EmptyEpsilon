...
function init()
    ...
    print(
        string.format(
            "    ----    Scenario: What the Dickens    ----    Version %s    ----    Tested with EE version %s    ----",
            scenario_version,
            ee_version
        )
    )
    ...
    stationBedlam =
        SpaceStation():setTemplate("Small Station"):setFaction(stationFaction)
    stationBedlam
        :setCallSign("Bedlam")
        :setPosition(27333, 54000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationTavistock =
        SpaceStation():setTemplate("Small Station"):setFaction(stationFaction)
    stationTavistock
        :setCallSign("Tavistock")
        :setPosition(-33111, -68222)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationCornhill =
        SpaceStation():setTemplate("Small Station"):setFaction(stationFaction)
    stationCornhill
        :setCallSign("Cornhill")
        :setPosition(78667, -20444)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationCamden =
        SpaceStation():setTemplate("Large Station"):setFaction(stationFaction)
    stationCamden
        :setCallSign("Camden")
        :setPosition(-65556, -82667)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationCity =
        SpaceStation():setTemplate("Huge Station"):setFaction(stationFaction)
    stationCity
        :setCallSign("City")
        :setPosition(82889, -10444)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationSomerset =
        SpaceStation():setTemplate("Large Station"):setFaction(stationFaction)
    stationSomerset
        :setCallSign("Somerset")
        :setPosition(500, -10000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationMillbank =
        SpaceStation():setTemplate("Medium Station"):setFaction(stationFaction)
    stationMillbank
        :setCallSign("Millbank")
        :setPosition(-35000, 48000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationChange =
        SpaceStation():setTemplate("Medium Station"):setFaction(stationFaction)
    stationChange
        :setCallSign("Change")
        :setPosition(85333, -21111)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationDevonshire =
        SpaceStation():setTemplate("Small Station"):setFaction(stationFaction)
    stationDevonshire
        :setCallSign("Devonshire")
        :setPosition(-82000, -59000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationCavendish =
        SpaceStation():setTemplate("Small Station"):setFaction(stationFaction)
    stationCavendish
        :setCallSign("Cavendish")
        :setPosition(-77000, -36000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationFoundling =
        SpaceStation():setTemplate("Small Station"):setFaction(stationFaction)
    stationFoundling
        :setCallSign("Foundling")
        :setPosition(-5000, -63000)
        :setDescription(
            _("scienceDescription-station", "Medical research and support")
        )
    stationSoho = SpaceStation()
    ...
    stationSoho
        :setCallSign("Soho")
        :setPosition(-40000, -28000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationGrosvenor =
        SpaceStation():setTemplate("Small Station"):setFaction(stationFaction)
    stationGrosvenor
        :setCallSign("Grosvenor")
        :setPosition(-92000, -12000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationPentonville =
        SpaceStation():setTemplate("Small Station"):setFaction(stationFaction)
    stationPentonville
        :setCallSign("Pentonville")
        :setPosition(50, -78000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationCovent =
        SpaceStation():setTemplate("Small Station"):setFaction(stationFaction)
    stationCovent
        :setCallSign("Covent")
        :setPosition(-15000, -14000)
        :setDescription(
            _("scienceDescription-station", "Hydroponics and plant life")
        )
    stationCheshire = SpaceStation()
        :setTemplate("Small Station")
        :setFaction(stationFaction)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationCheshire
        :setCallSign("Cheshire")
        :setPosition(23000, -23000)
        :setDescription(_("scienceDescription-station", "Cheese, food, drink"))
    stationSouthwark =
        SpaceStation():setTemplate("Medium Station"):setFaction(stationFaction)
    stationSouthwark
        :setCallSign("Southwark")
        :setPosition(52000, 19000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationLambeth =
        SpaceStation():setTemplate("Medium Station"):setFaction(stationFaction)
    ...
    stationTower
        :setCallSign("Tower")
        :setPosition(118000, 3000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationCripplegate =
        SpaceStation():setTemplate("Small Station"):setFaction(stationFaction)
    stationCripplegate
        :setCallSign("Cripplegate")
        :setPosition(60500, -50500)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationHolborn =
        SpaceStation():setTemplate("Medium Station"):setFaction(stationFaction)
    stationHolborn
        :setCallSign("Holborn")
        :setPosition(25000, -46000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationBloomsbury =
        SpaceStation():setTemplate("Small Station"):setFaction(stationFaction)
    stationBloomsbury
        :setCallSign("Bloomsbury")
        :setPosition(-50, -57000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationSpitalfields =
        SpaceStation():setTemplate("Medium Station"):setFaction(stationFaction)
    stationSpitalfields
        :setCallSign("Spitalfields")
        :setPosition(117000, -39000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationBishopsgate =
        SpaceStation():setTemplate("Small Station"):setFaction(stationFaction)
    stationBishopsgate
        :setCallSign("Bishopsgate")
        :setPosition(101000, -32000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationMoorgate =
        SpaceStation():setTemplate("Small Station"):setFaction(stationFaction)
    stationMoorgate
        :setCallSign("Moorgate")
        :setPosition(82000, -40000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationWestminster =
        SpaceStation():setTemplate("Medium Station"):setFaction(stationFaction)
    stationWestminster
        :setCallSign("Westminster")
        :setPosition(-36000, 51000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationBuckingham =
        SpaceStation():setTemplate("Medium Station"):setFaction(stationFaction)
    stationBuckingham
        ...
        :setPosition(-68000, 33000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationKensington =
        SpaceStation():setTemplate("Small Station"):setFaction(stationFaction)
    stationKensington
        :setCallSign("Kensington")
        :setPosition(-108000, 35000)
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationAldgate =
        SpaceStation():setTemplate("Small Station"):setFaction(stationFaction)
    ...
    waterLooZone:setPoints(5556, 9556, -4667, -1556, 889, -5778, 11111, 6222)
    blackFriarZone = Zone():setColor(0, 0, 0)
    blackFriarZone:setPoints(
        35778,
        3111,
        34444,
        -9556,
    ...
    londonZone:setPoints(85111, 13111, 79778, 12000, 84889, 0, 89556, 222)
    westMinsterZone = Zone():setColor(0, 0, 0)
    westMinsterZone:setPoints(
        -5778,
        33378,
        -6000,
        39111,
    ...
    player = PlayerSpaceship()
        ...
        :setTemplate("Repulse")
        :setCallSign("HMS Scrooge")
        :addReputationPoints(77)
    ...
    primaryOrders = string.format(
        _("orders-comms", "Protect Somerset in %s"),
        stationSomerset:getSectorName()
    )
    secondaryOrders = ""
    optionalOrders = ""
    ...
    if amount > arcLen then
        for ndex = 1, arcLen do
            ...
            if isObjectType(obj, "Asteroid") then
                ...
                VisualAsteroid()
                    :setPosition(ax + random(-500, 500), ay + random(-500, 500))
                    :setSize(random(10, 800))
                VisualAsteroid()
                    :setPosition(ax + random(-500, 500), ay + random(-500, 500))
                    :setSize(random(10, 800))
            end
...
function zoneChecks(delta)
    if riverZone:isInside(player) then
        if
            not waterLooZone:isInside(player)
            and not blackFriarZone:isInside(player)
            and not westMinsterZone:isInside(player)
            and not vauxHallZone:isInside(player)
            and not londonZone:isInside(player)
            and not southwarkZone:isInside(player)
        then
            if riverZoneWarningMessage == nil then
                player:addToShipLog(
                    _(
                        "riverWarning-shipLog",
                        "Reminder to all newcomers to the London area: the river area damages ship systems. Jump the river or use the provided bridges"
                    ),
                    "Magenta"
                )
            ...
            if systemHit == 1 then
                player:setSystemHealth(
                    "reactor",
                    player:getSystemHealth("reactor") * 0.99
                )
            elseif systemHit == 2 then
                player:setSystemHealth(
                    "beamweapons",
                    player:getSystemHealth("beamweapons") * 0.99
                )
            elseif systemHit == 3 then
                player:setSystemHealth(
                    "maneuver",
                    player:getSystemHealth("maneuver") * 0.99
                )
            elseif systemHit == 4 then
                player:setSystemHealth(
                    "missilesystem",
                    player:getSystemHealth("missilesystem") * 0.99
                )
            elseif systemHit == 5 then
                player:setSystemHealth(
                    "warp",
                    player:getSystemHealth("warp") * 0.99
                )
            elseif systemHit == 6 then
                player:setSystemHealth(
                    "jumpdrive",
                    player:getSystemHealth("jumpdrive") * 0.99
                )
            elseif systemHit == 7 then
                player:setSystemHealth(
                    "frontshield",
                    player:getSystemHealth("frontshield") * 0.99
                )
            else
                player:setSystemHealth(
                    "rearshield",
                    player:getSystemHealth("rearshield") * 0.99
                )
            end
        end
    end
...
function handleDockedState()
    ...
    if player:getWeaponStorageMax("Homing") > 0 then
        addCommsReply(
            string.format(
                _(
                    "ammo-comms",
                    "Do you have spare homing missiles for us? (%d rep each)"
                ),
    ...
    if player:getWeaponStorageMax("HVLI") > 0 then
        addCommsReply(
            string.format(
                _("ammo-comms", "Can you restock us with HVLI? (%d rep each)"),
                getWeaponCost("HVLI")
            ),
            function()
    ...
    if player:getWeaponStorageMax("Mine") > 0 then
        addCommsReply(
            string.format(
                _("ammo-comms", "Please re-stock our mines. (%d rep each)"),
                getWeaponCost("Mine")
            ),
            function()
    ...
    if player:getWeaponStorageMax("Nuke") > 0 then
        addCommsReply(
            string.format(
                _(
                    "ammo-comms",
                    "Can you supply us with some nukes? (%d rep each)"
                ),
                getWeaponCost("Nuke")
            ),
            function()
    ...
    if player:getWeaponStorageMax("EMP") > 0 then
        addCommsReply(
            string.format(
                _(
                    "ammo-comms",
                    "Please re-stock our EMP missiles. (%d rep each)"
                ),
                getWeaponCost("EMP")
            ),
            function()
    ...
    if player:isFriendly(comms_target) then
        ...
        addCommsReply(
            _("areaDescription-comms", "Interesting points in the area"),
            function()
                setCommsMessage(
                    _(
                        "areaDescription-comms",
                        "You may be interested in one or more of these:"
                    )
                )
                addCommsReply(_("areaDescription-comms", "City"), function()
                    setCommsMessage(
                        _(
                            "areaDescription-comms",
                            "The City station represents one of the most developed stations in the area. Correlating the station to olde Earth, this would be where the walled medieval area of London would have been located"
                        )
                    )
                    addCommsReply(_("Back"), commsStation)
                end)
                addCommsReply(_("areaDescription-comms", "Change"), function()
                    setCommsMessage(
                        _(
                            "areaDescription-comms",
                            "Much of the area's financial business is handled at the station named Change. The station name is an oblique reference to the Royal Exchange of London"
                        )
                    )
                    addCommsReply(_("Back"), commsStation)
                end)
                addCommsReply(
                    _("areaDescription-comms", "Foundling"),
                    function()
                        setCommsMessage(
                            _(
                                "areaDescription-comms",
                                "Foundling station specializes in medical research for children. The station name honors Foundling Hospital in London, an orphanage established in 1739 by Captain Thomas Coram, a retired seaman"
                            )
                        )
                        addCommsReply(_("Back"), commsStation)
                    end
                ...
                addCommsReply(_("areaDescription-comms", "Covent"), function()
                    setCommsMessage(
                        _(
                            "areaDescription-comms",
                            "Most of the area's food supply comes from station Covent. It specializes in hydroponics. THe station derives its name from Covent Garden from olde Earth London where fruits, vegetables and flowers were bought and sold"
                        )
                    )
                    addCommsReply(_("Back"), commsStation)
                end)
                addCommsReply(_("areaDescription-comms", "Cheshire"), function()
                    setCommsMessage(
                        _(
                            "areaDescription-comms",
                            "You can find fine dining and drinking at Cheshire station. The name alludes to the Ye Olde Cheshire Cheese pub from London on olde earth"
                        )
                    )
                    addCommsReply(_("Back"), commsStation)
                end)
                addCommsReply(_("areaDescription-comms", "Tower"), function()
                    setCommsMessage(
                        _(
                            "areaDescription-comms",
                            "Station Tower serves as a residence for the wealthiest members of the London area community"
                        )
                    )
                    addCommsReply(_("Back"), commsStation)
                end)
    ...
    if comms_target == stationCamden then
        addCommsReply(
            _(
                "station-comms",
                "What do you know about unusual readings around here?"
            ),
            function()
                local reference_visual_asteroid =
                    VisualAsteroid():setPosition(-51273, -88975):setSize(115)
                setCommsMessage(
                    string.format(
                        _(
                            "station-comms",
                            "The unusual readings happen in %s. They are sporadic, illogical, and creepy."
                        ),
                        reference_visual_asteroid:getSectorName()
                    )
                )
                addCommsReply(_("Back"), commsStation)
    ...
    if getScenarioTime() > plot1_time then
        player:addToShipLog(
            string.format(
                _(
                    "goal-shipLog",
                    "Your mission is to protect station Somerset in %s. Other missions may be added. Dock with Somerset for additional mission parameters. Welcome to the London area of human navy influence"
                ),
                stationSomerset:getSectorName()
            ),
            "Magenta"
    ...
    if player:isDocked(stationSomerset) then
        ...
        player:addToShipLog(
            string.format(
                _(
                    "ordersAudio-shipLog",
                    "Investigate unusual sensor readings near station Camden in %s"
                ),
                reference_visual_asteroid:getSectorName()
            ),
            "Magenta"
        ...
        secondaryOrders = string.format(
            _("orders-comms", "Investigate near station Camden in %s"),
            reference_visual_asteroid:getSectorName()
        )
        plot1 = arriveA2
        plot1name = "arriveA2"
...
function arriveA2(delta)
    ...
    if px > -60000 and px < -40000 and py > -100000 and py < -80000 then
        ...
        marleyArt = Artifact()
            ...
            :allowPickup(false)
            :setDescriptions(
                _("scienceDescription-artifact", "Rusty Chain Link"),
                _(
                    "scienceDescription-artifact",
                    "Translucent but glowing rusty chain link"
                )
            )
            :setRadarSignatureInfo(0, 0, 0.9)
...
function scanMarleyArtifact(delta)
    if marleyArt:isScannedBy(player) then
        player:addToShipLog(
            _(
                "audio-shipLog",
                "[Jacob Marley] Do you remember your partner from previous missions? Especially the one where Marley station was destroyed? I am doomed to haunt this area of space forever. Take care or suffer the same fate."
            ),
            "Red"
        )
...
function marleyMob(delta)
    if getScenarioTime() > plot1_time then
        ...
        player:addToShipLog(
            _(
                "ordersAudio-shipLog",
                "[Jacob Marley] You must defeat the chains that bind you in the form of Kraylor ships"
            ),
            "Red"
        )
    ...
    if marleyMobCount == 0 then
        ...
        player:addToShipLog(
            string.format(
                _(
                    "ordersAudio-shipLog",
                    "[Jacob Marley] Defeating the Kraylors gives you an idea of what is to come. Return to Somerset in %s and prepare for three ghostly visits"
                ),
                stationSomerset:getSectorName()
            ),
            "Red"
    ...
    if player:isDocked(stationSomerset) then
        ...
        player:addToShipLog(
            string.format(
                _(
                    "ordersAudio-shipLog",
                    "I'm guessing you handled whatever was in %s. Those unusual readings have disappeared. However, we show an unusually high level of chroniton particles near station Millbank in %s. Recommend you investigate."
                ),
                reference_visual_asteroid:getSectorName(),
                stationMillbank:getSectorName()
            ),
            "Magenta"
        )
        ...
        secondaryOrders = string.format(
            _(
                "orders-comms",
                "Investigate chroniton particles near station Millbank in %s"
            ),
            stationMillbank:getSectorName()
        )
...
function arriveNearMillbank(delta)
    if distance(player, stationMillbank) < 15000 then
        ...
        pastArt = Artifact()
            :setPosition(smx + vx, smy + vy)
            :setModel("artifact3")
            :allowPickup(false)
            :setDescriptions(
                _("scienceDescription-artifact", "Tiny escape pod"),
                _(
                    "scienceDescription-artifact",
                    "Tiny escape pod from a previous generation"
                )
            )
            :setRadarSignatureInfo(0, 0.9, 0)
...
function fez3Effect(delta)
    if getScenarioTime() > fez_3_time then
        stationFezziwig = SpaceStation()
            :setTemplate("Small Station")
            :setFaction("Human Navy")
            :setCallSign("Fezziwig")
            :setPosition(fezx, fezy)
...
function fezWelcomeMessage(delta)
    if getScenarioTime() > fez_welcome_time then
        player:addToShipLog(
            _(
                "audio-shipLog",
                "Welcome to the Christmases of your past, Scrooge"
            ),
            "Blue"
        )
...
function fezFleet(delta)
    if getScenarioTime() > fez_fleet_time then
        ...
        enemyAliBabba = CpuShip()
            :setFaction("Exuari")
            :setCallSign("Ali Babba")
            :setTemplate("WX-Lindworm")
            :orderAttack(player)
            :setPosition(px + vx, py + vy)
            :setRotation(startAngle + 170)
        table.insert(fezList, enemyAliBabba)
        plot1 = destroyFezFleet
        plot1name = "destroyFezFleet"
        vx, vy = vectorFromAngle(startAngle + 10, 5000)
        enemyValentine = CpuShip()
            :setFaction("Exuari")
            :setCallSign("Valentine")
            :setTemplate("WX-Lindworm")
            :orderAttack(player)
            :setPosition(px + vx, py + vy)
            :setRotation(startAngle + 190)
    ...
    if fezFleetCount == 0 then
        ...
        player:addToShipLog(
            string.format(
                _(
                    "ordersAudio-shipLog",
                    "Belle has come. Be sure she makes it to Fezziwig in %s"
                ),
                stationFezziwig:getSectorName()
            ),
            "Blue"
        )
        ...
        friendBelle = CpuShip()
            ...
            :orderDock(stationFezziwig)
            :setPosition(fezx + vx, fezy + vy)
            :setRotation(belleAngle + 180)
...
function belleNemesis(delta)
    if getScenarioTime() > belle_nemesis_time then
        ...
        if difficulty > 1 then
            ...
            vx, vy = vectorFromAngle(belleAngle + 20, 24000)
            enemyContract = CpuShip()
                :setFaction("Exuari")
                :setCallSign("Contract")
                :setTemplate("MT52 Hornet")
                :orderRoaming()
                :setPosition(fezx + vx, fezy + vy)
                :setRotation(startAngle + 200)
...
function destroyBelleFleet(delta)
    if not friendBelle:isValid() then
        globalMessage(
            _(
                "msgMainscreen",
                "You did not protect Belle, your dearest love. HMS Scrooge experienced catastrophic environmental systems failure due to crew anguish. All of you suffocated."
            )
        )
        victory("Exuari")
    end
    ...
    if
        belleFleetCount == 0
        or distance(friendBelle, stationFezziwig) < 1000
    then
        player:addReputationPoints(50)
        player:addToShipLog(
            _("ordersAudio-shipLog", "You protected Belle. Somerset awaits"),
            "Blue"
        )
    ...
    if player:isDocked(stationSomerset) then
        player:addToShipLog(
            string.format(
                _(
                    "ordersAudio-shipLog",
                    "Our sensors indicated nebulas forming then disappearing. That is impossible, of course. We started level three diagnostics on our sensors to discover what's wrong. Just before starting the diagnostic, we picked up unusual readings near Bedlam in %s. Perhaps you should investigate"
                ),
                stationBedlam:getSectorName()
            ),
            "Magenta"
        )
        playSoundFile("audio/scenario/62/sa_62_London3.ogg")
        secondaryOrders = string.format(
            _("orders-comms", "Investigate unusual readings near Bedlam in %s"),
            stationBedlam:getSectorName()
        )
...
function arriveNearBedlam(delta)
    if distance(player, stationBedlam) < 3000 then
        player:addToShipLog(
            _(
                "ordersAudio-shipLog",
                "[Bob Cratchit on station Bedlam] Happy Christmas, Scrooge! You are just in time to make our holiday bright. I know it is against your nature, but surely you can decorate our skies with alien enemy ship explosions. In the worst case, we will get a sky decorated with your ship exploding."
            ),
            "Yellow"
        )
        ...
        if difficulty > 1 then
            ...
            enemyYuletide = CpuShip()
                :setFaction("Ghosts")
                :setCallSign("Yuletide")
                :setTemplate("Phobos T3")
                :orderRoaming()
                :setPosition(px + vx, py + vy)
    ...
    if cratchitFleetCount == 0 then
        if stationBedlam:isValid() then
            ...
            player:addToShipLog(
                _(
                    "ordersAudio-shipLog",
                    "[Bob Cratchit on station Bedlam] I hate to dampen your spirits, but my young maintenance technician, Tim, has become seriously ill. Our medical facilities cannot diagnose, much less treat him. The medical ship Turkey Surprise should be able to help. Could you dock with Bedlam and transport Tim to Turkey Surprise?"
                ),
                "Yellow"
            )
            ...
            friendTurkeySurprise = CpuShip()
                :setFaction("Human Navy")
                :setCallSign("Turkey Surprise")
                :setTemplate("Equipment Freighter 3")
                :orderDock(stationSomerset)
                :setPosition(bx + vx, by + vy)
                :setScannedByFaction("Human Navy", true)
            plot1 = timIll
            plot1name = "timIll"
            secondaryOrders =
                _("orders-comms", "Take Tim from Bedlam to Turkey Surprise")
            timAboard = false
            plot2 = turkeyNemesis
            ...
            globalMessage(
                _(
                    "msgMainscreen",
                    "While you fought off the ships near Bedlam, Tiny Tim, Bob Cratchit's maintenance technician perished along with the others aboard station Bedlam. Your engineering crew were so overcome with grief that they neglected a routie maintenance cycle causing engine failure on HMS Scrooge."
                )
            )
            victory("Ghosts")
        end
    ...
    if not timAboard then
        if player:isDocked(stationBedlam) then
            ...
            local remaining_minutes =
                math.floor((tim_life_time - getScenarioTime()) / 60)
            if remaining_minutes < 1 then
                player:addToShipLog(
                    string.format(
                        _(
                            "shipLog",
                            "[Bob Cratchit] Tim has been transported aboard %s. Hurry to Turkey Surprise. The doctors say he has about %i seconds to live"
                        ),
                        player:getCallSign(),
                        math.floor((tim_life_time - getScenarioTime()))
                    ),
                    "Yellow"
                )
            else
                if remaining_minutes > 1 then
                    player:addToShipLog(
                        string.format(
                            _(
                                "shipLog",
                                "[Bob Cratchit] Tim has been transported aboard %s. Hurry to Turkey Surprise. The doctors say he has about %i minutes to live"
                            ),
                            player:getCallSign(),
                            remaining_minutes
                        ),
                    ...
                    player:addToShipLog(
                        string.format(
                            _(
                                "shipLog",
                                "[Bob Cratchit] Tim has been transported aboard %s. Hurry to Turkey Surprise. The doctors say he has about %i minute to live"
                            ),
                            player:getCallSign(),
                            remaining_minutes
                        ),
            ...
            if halfMsg == nil then
                ...
                player:addToShipLog(
                    string.format(
                        _(
                            "shipLog",
                            "[Bob Cratchit] Please hurry, the doctors say Tim has less than %i seconds to live"
                        ),
                        math.floor(getScenarioTime() - tim_half_life_time)
                    ),
                    "Yellow"
                )
            end
            ...
            if halfMsg == nil then
                ...
                player:addToShipLog(
                    string.format(
                        _(
                            "shipLog",
                            "[Sick Bay] Tim has less than %i seconds to live"
                        ),
                        math.floor(getScenarioTime() - tim_half_life_time)
                    ),
                    "Magenta"
        ...
        if friendTurkeySurprise:isValid() then
                ...
                if player:getShieldsActive() then
                    if shieldsOnMsg == nil then
                        ...
                        player:addToShipLog(
                            _(
                                "audio-shipLog",
                                "[Turkey Surprise] We cannot transport through your shields. Please lower them"
                            ),
                            "Cyan"
                        )
                    ...
                    player:addToShipLog(
                        _(
                            "ordersAudio-shipLog",
                            "[Turkey Surprise] We have transported Tim and our doctors are examining him"
                        ),
                        "Cyan"
                    )
                    ...
                    plot1name = "timHeal"
                    secondaryOrders =
                        _("orders-comms", "Protect Turkey Surprise")
            ...
            globalMessage(
                string.format(
                    _(
                        "msgMainscreen",
                        "Tim dies with Turkey Surprise. %s disabled by a broken heart (engine failure)"
                    ),
                    player:getCallSign()
                )
            )
    ...
    if getScenarioTime() > tim_life_time then
        globalMessage(
            string.format(
                _(
                    "msgMainscreen",
                    "Tim dies. %s disabled by a broken heart (engine failure)"
                ),
                player:getCallSign()
            )
        )
...
function timHeal(delta)
    if getScenarioTime() > tim_heal_time then
        player:addToShipLog(
            _(
                "ordersAudio-shipLog",
                "[Bob Cratchit] Turkey Surprise tells me Tim is doing fine. In fact, he's ready to return to duty. We need him here for critical repairs. Would you bring him home, please?"
            ),
            "Yellow"
        )
    ...
    if timAboard then
        if player:isDocked(stationBedlam) then
            player:addToShipLog(
                _(
                    "ordersAudio-shipLog",
                    "[Bob Cratchit] We are so glad Tim is better. He serves a critical role here. Somerset is looking for you"
                ),
                "Yellow"
            )
        ...
        if distance(friendTurkeySurprise, player) < 500 then
            if player:getShieldsActive() then
                ...
                player:addToShipLog(
                    _(
                        "shipLog",
                        "[Transporter Room] Tim has been transported aboard. Bedlam is wating for us to bring him back to work on repairs"
                    ),
                    "Magenta"
                )
                timAboard = true
    ...
    if player:isDocked(stationSomerset) then
        player:addToShipLog(
            string.format(
                _(
                    "ordersAudio-shipLog",
                    "We are glad you took care of those Ghosts in the machine. They came out of nowhere! We still saw some impossible sensor readings even after our sensor overhaul. We are now conducting a level 5 diagnostic and repair regimen. Keep an eye on the City in %s"
                ),
                stationCity:getSectorName()
            ),
            "Magenta"
        )
        playSoundFile("audio/scenario/62/sa_62_London4.ogg")
        secondaryOrders = string.format(
            _("orders-comms", "Watch the City in %s"),
            stationCity:getSectorName()
        )
...
function futureEffect4(delta)
    if getScenarioTime() > future_effect_4_time then
        ...
        stationGraveyard = SpaceStation()
            :setTemplate("Small Station")
            :setFaction("Independent")
            :setCallSign("Graveyard")
            :setPosition(futx + vx, futy + vy)
        stationGraveyard.angle = 0
        vx, vy = vectorFromAngle(120, 2500)
        stationCemetery = SpaceStation()
            :setTemplate("Small Station")
            :setFaction("Independent")
            :setCallSign("Cemetery")
            :setPosition(futx + vx, futy + vy)
        stationCemetery.angle = 120
        vx, vy = vectorFromAngle(240, 2500)
        stationNecropolis = SpaceStation()
            :setTemplate("Small Station")
            :setFaction("Independent")
            :setCallSign("Necropolis")
            :setPosition(futx + vx, futy + vy)
...
function spawnGraveyard()
    ...
    if difficulty > 1 then
        enemyBedCurtain = CpuShip()
            :setFaction("Ktlitans")
            :setCallSign("Bed Curtain")
            :setTemplate("Ktlitan Drone")
            :orderAttack(player)
            :setPosition(futx, futy + 800)
...
function spawnCemetery()
    ...
    if difficulty >= 1 then
        ...
        enemyCreditor = CpuShip()
            :setFaction("Ktlitans")
            :setCallSign("Creditor")
            :setTemplate("Ktlitan Scout")
            :orderAttack(player)
            :setPosition(futx, futy - 800)
...
function returnMsg1(delta)
    player:addToShipLog(
        _(
            "return-shipLog",
            "Dock at Somerset for a well deserved Christmas break"
        ),
        "Magenta"
    )
    plot1 = returnMsg2
...
function returnMsg2(delta)
    if
        getScenarioTime() > return_message_2_time
        and distance(player, stationSomerset) < 80000
    then
        player:addToShipLog(
            _(
                "returnAudio-shipLog",
                "[Jacob Marley] Good to see you spreading joy and easing pain, Scrooge"
            ),
            "Red"
        )
...
function returnMsg3(delta)
    if
        getScenarioTime() > return_message_3_time
        and distance(player, stationSomerset) < 70000
    then
        player:addToShipLog(
            _(
                "returnAudio-shipLog",
                "May the shadows of the things that have been continue to remind you of the joy of Christmas"
            ),
            "Blue"
        )
...
function returnMsg4(delta)
    if
        getScenarioTime() > return_message_4_time
        and distance(player, stationSomerset) < 60000
    then
        player:addToShipLog(
            _(
                "return-shipLog",
                "Despite Ignorance and Want, prisons and workhouses, know each day fully and celebrate it, especially Christmas"
            ),
            "Yellow"
        )
        plot1 = returnMsg5
...
function returnMsg5(delta)
    if
        getScenarioTime() > return_message_5_time
        and distance(player, stationSomerset) < 50000
    then
        player:addToShipLog(
            _(
                "returnAudio-shipLog",
                "[Urchin Express]\nHappy Christmas, sir!\nTop o' the day to ya!\nThanks for the shillings!"
            ),
            "Cyan"
        )
...
function returnMsg6(delta)
    if
        getScenarioTime() > return_message_6_time
        and distance(player, stationSomerset) < 40000
    then
        player:addToShipLog(
            _(
                "returnAudio-shipLog",
                "[Fred from QE17] Merry Christmas, uncle! Stop by and share Christmas dinner with us when you're off duty"
            ),
            "Green"
        )
...
function returnMsg7(delta)
    if
        getScenarioTime() > return_message_7_time
        and distance(player, stationSomerset) < 30000
    then
        player:addToShipLog(
            _(
                "returnAudio-shipLog",
                "[Bob on Cratchit Cruiser] Happy Christmas, Mr. Scrooge. Thanks for the raise and for helping Tiny Tim"
            ),
            "Yellow"
        )
...
function returnMsg8(delta)
    if
        getScenarioTime() > return_message_8_time
        and distance(player, stationSomerset) < 20000
    then
        player:addToShipLog(
            _(
                "returnAudio-shipLog",
                "[Tim on Cratchit Cruiser] God bless us every one"
            ),
            "White"
        )
...
function returnMsg9(delta)
    if
        getScenarioTime() > return_message_9_time
        and distance(player, stationSomerset) < 10000
    then
        if difficulty > 1 then
            player:addToShipLog(
                _(
                    "returnAudio-shipLog",
                    "[Tim on Cratchit Cruiser] Give me some freakin' eggnog"
                ),
                "White"
            )
...
function turkeyNemesis(delta)
    if getScenarioTime() > turkey_nemesis_time then
        ...
        enemyCrutch = CpuShip()
            ...
            :orderAttack(friendTurkeySurprise)
            :setPosition(tx + vx, ty + vy)
        ...
        enemyConsumption = CpuShip()
            :setFaction("Ghosts")
            :setCallSign("Consumption")
            :setTemplate("Karnack")
            :orderAttack(friendTurkeySurprise)
            :setPosition(tx + vx, ty + vy)
        ...
        if difficulty >= 1 then
            tgAngle = random(0, 360)
            vx, vy = vectorFromAngle(tgAngle, random(4000, 5000))
            enemyMalnutrition = CpuShip()
                :setFaction("Ghosts")
                :setCallSign("Malnutrition")
                :setTemplate("Piranha F12")
                :orderAttack(friendTurkeySurprise)
                :setPosition(tx + vx, ty + vy)
...
function presentHunters(delta)
    if getScenarioTime() > present_hunters_time then
        ...
        enemyGoose = CpuShip()
            ...
            :setCallSign("Goose")
            :setTemplate("Gunship")
            :orderAttack(stationSomerset)
            :setPosition((tx + sx) / 2, (ty + sy) / 2)
        table.insert(turkeyList, enemyGoose)
        plot2 = presentOutrage
        plot2name = "presentOutrage"
        present_outrage_time = getScenarioTime() + 30
        if difficulty >= 1 then
            enemySuckingPig = CpuShip()
                :setFaction("Ghosts")
                :setCallSign("Sucking Pig")
                :setTemplate("Gunship")
                :orderAttack(stationSomerset)
                :setPosition((tx + sx) / 2 + 1000, (ty + sy) / 2)
            table.insert(turkeyList, enemySuckingPig)
            enemyMincePie = CpuShip()
                :setFaction("Ghosts")
                :setCallSign("Mince Pie")
                :setTemplate("Gunship")
                :orderAttack(stationSomerset)
                :setPosition((tx + sx) / 2 - 1000, (ty + sy) / 2)
        ...
        if difficulty > 1 then
            enemyPlumPudding = CpuShip()
                :setFaction("Ghosts")
                :setCallSign("Plum Pudding")
                :setTemplate("Gunship")
                :orderAttack(stationSomerset)
                :setPosition((tx + sx) / 2, (ty + sy) / 2 + 1000)
            table.insert(turkeyList, enemyPlumPudding)
            enemyChestnut = CpuShip()
                :setFaction("Ghosts")
                :setCallSign("Chestnut")
                :setTemplate("Gunship")
                :orderAttack(stationSomerset)
                :setPosition((tx + sx) / 2, (ty + sy) / 2 - 1000)
...
function presentOutrage(delta)
    if getScenarioTime() > present_outrage_time then
        player:addToShipLog(
            _("audio-shipLog", "How dare you bring us here!"),
            "85,107,47"
        )
...
function presentIntent(delta)
    if getScenarioTime() > present_intent_time then
        player:addToShipLog(
            _(
                "audio-shipLog",
                "Silence! Since we are here, let us destroy Somerset"
            ),
            "85,107,47"
        )
...
function moveNebula(delta)
    for nidx = 1, #movingNebula do
        newAngle = movingNebula[nidx].angle + 0.1
...
function orbitStations(delta)
    newStationAngle = stationGraveyard.angle - 0.1
    ...
    newStationAngle = stationCemetery.angle - 0.1
    if newStationAngle < 0 then
        newStationAngle = newStationAngle + 360
    end
    ...
    newStationAngle = stationNecropolis.angle - 0.1
    if newStationAngle < 0 then
        newStationAngle = newStationAngle + 360
    end
    ...
    if getScenarioTime() > ghostly_hint_time then
        if ghostly_hint_sent == nil then
            player:addToShipLog(
                _("shipLog", "Dock with Graveyard, Cemetery and Necropolis."),
                "178,34,34"
            )
    ...
    if not stationSomerset:isValid() then
        globalMessage(
            string.format(
                _(
                    "msgMainscreen",
                    "Somerset destroyed. %s dishonored and meaner. Christmas is ruined"
                ),
                player:getCallSign()
            )
        )
