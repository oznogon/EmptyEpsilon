...
-- Returns true if the entity's collider is a circle.
function isColliderCircular(obj)
    local physics = obj.components.physics
    return physics ~= nil and type(physics.size) != "table";
end
