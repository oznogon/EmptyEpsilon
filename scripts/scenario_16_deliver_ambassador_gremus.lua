...
function init()
    ...
    print(
        string.format(
            "    ----    Scenario: Deliver Ambassador Gremus    ----    Version %s    ----    Tested with EE version %s    ----",
            scenario_version,
            ee_version
        )
    )
    ...
    stationList = {}
    outpost41 = SpaceStation()
        :setTemplate("Small Station")
        :setFaction("Human Navy")
        :setCommsScript("")
        :setCommsFunction(commsStation)
    outpost41
        :setPosition(22400, 16100)
        :setCallSign("Outpost-41")
        :setDescription(
            _(
                "scienceDescription-station",
                "Strategically located human station"
            )
        )
    ...
    outpost13 = SpaceStation()
        :setTemplate("Small Station")
        :setFaction("Independent")
        :setCommsScript("")
        :setCommsFunction(commsStation)
    outpost13
        :setPosition(12600, 27554)
        :setCallSign("Outpost-13")
        :setDescription(
            _(
                "scienceDescription-station",
                "Gathering point for asteroid miners"
            )
        )
    ...
    science37 = SpaceStation()
        :setTemplate("Small Station")
        :setFaction("Human Navy")
        :setCommsScript("")
        :setCommsFunction(commsStation)
    science37
        :setPosition(-18200, -32554)
        :setCallSign("Science-37")
        :setDescription(_("scienceDescription-station", "Observatory"))
    table.insert(stationList, science37)
    bpcommnex = SpaceStation()
        :setTemplate("Small Station")
        :setFaction("Independent")
        :setCommsScript("")
        :setCommsFunction(commsStation)
    bpcommnex
        :setPosition(-53500, 84000)
        :setCallSign("BP Comm Nex")
        :setDescription(
            _(
                "scienceDescription-station",
                "Balindor Prime Communications Nexus"
            )
        )
    ...
    stationOrdinkal = SpaceStation()
        :setTemplate("Medium Station")
        :setFaction("Independent")
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationOrdinkal
        :setPosition(-14600, 47554)
        :setCallSign("Ordinkal")
        :setDescription(_("scienceDescription-station", "Trading Post"))
    table.insert(stationList, stationOrdinkal)
    stationNakor = SpaceStation()
        :setTemplate("Medium Station")
        :setFaction("Independent")
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationNakor
        :setPosition(-34310, -37554)
        :setCallSign("Nakor")
        :setDescription(
            _("scienceDescription-station", "Science and trading hub")
        )
    table.insert(stationList, stationNakor)
    stationKelfist =
        SpaceStation():setTemplate("Medium Station"):setFaction("Kraylor")
    stationKelfist:setPosition(44640, 13554):setCallSign("Kelfist")
    table.insert(stationList, stationKelfist)
    stationFranklin = SpaceStation()
        :setTemplate("Large Station")
        :setFaction("Human Navy")
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationFranklin
        :setPosition(-24640, -13554)
        :setCallSign("Franklin")
        :setDescription(
            _("scienceDescription-station", "Civilian and military station")
        )
    table.insert(stationList, stationFranklin)
    stationBroad =
        SpaceStation():setTemplate("Large Station"):setFaction("Independent")
    stationBroad
        :setPosition(44340, 63554)
        :setCallSign("Broad")
        :setDescription(_("scienceDescription-station", "Trading Post"))
    ...
    stationBazamoana
        :setPosition(35, 87)
        :setCallSign("Bazamoana")
        :setDescription(_("scienceDescription-station", "Trading Nexus"))
    table.insert(stationList, stationBazamoana)
    stationPangora = SpaceStation()
        :setTemplate("Huge Station")
        :setFaction("Human Navy")
        :setCommsScript("")
        :setCommsFunction(commsStation)
    stationPangora
        :setPosition(72340, -23554)
        :setCallSign("Pangora")
        :setDescription(
    ...
    kraylorChaserList = {}
    kraylorChaser1 = CpuShip()
        :setTemplate("Phobos T3")
        :setFaction("Kraylor")
        :setPosition(24000, 18200)
        :setHeading(270)
    kraylorChaser1
        :orderAttack(player)
        :setScanned(true)
        :setCallSign(generateCallSign(nil, "Kraylor"))
    table.insert(kraylorChaserList, kraylorChaser1)
    if difficulty_variation ~= "Easy" then
        kraylorChaser2 = CpuShip()
            :setTemplate("Phobos T3")
            :setFaction("Kraylor")
            :setPosition(24000, 18600)
            :setHeading(270)
        kraylorChaser2
            :orderFlyFormation(kraylorChaser1, 0, 400)
            :setScanned(true)
            :setCallSign(generateCallSign(nil, "Kraylor"))
        table.insert(kraylorChaserList, kraylorChaser2)
    end
    if difficulty_variation == "Hard" then
        kraylorChaser3 = CpuShip()
            :setTemplate("Phobos T3")
            :setFaction("Kraylor")
            :setPosition(24000, 17800)
            :setHeading(270)
        kraylorChaser3
            :orderFlyFormation(kraylorChaser1, 0, -400)
            :setScanned(true)
        ...
        if getScenarioTime() > transport_spawn_time then
            ...
            if #transportList < maxTransport then
                ...
                local name = string.format(
                    "%s Freighter %i",
                    transport_name[math.random(1, #transport_name)],
                    math.random(1, 5)
                )
                ...
                local transport =
                    CpuShip():setTemplate(name):setFaction("Independent")
                transport
                    :setCommsScript("")
                ...
                transport:orderDock(transport.target)
                local tx, ty =
                    vectorFromAngle(random(0, 360), random(25000, 40000))
...
function createAsteroidsOnLine(
    x1,
    y1,
    x2,
    y2,
    ...
    for cnt_x = 0, d, spacing do
        for cnt_y = 0, (rows - 1) * spacing, spacing do
            ...
            if a ~= nil then
                if
                    isObjectType(a, "Asteroid")
                    or isObjectType(a, "VisualAsteroid")
                then
...
function getAmbassador(delta) --1st Gremus mission, create planet, and set foment time
    ...
    outpost41:sendCommsMessage(
        player,
        _(
            "audio-incCall",
            "Audio message received. Auto-transcribed into log. Stored for playback: CMDMICHL012"
        )
    )
    player:addToShipLog(
        string.format(
            _(
                "audio-shipLog",
                "[CMDMICHL012](Commander Michael) %s, avoid contact where possible. Get ambassador Gremus at Balindor Prime"
            ),
            playerCallSign
        ),
        "Yellow"
    ...
    if player.play_msg_michael_button == nil then
        ...
        player:addCustomButton(
            "Relay",
            player.play_msg_michael_button,
            _("audio-buttonRelay", "|> CMDMICHL012"),
            function()
    ...
    balindorPrime = Planet()
        :setPosition(-50500, 84000)
...
function ambassadorAboard(delta) --Take Gremus to Ningling msg, create Ningling, add rep
    ...
    if distance(player, balindorPrime) < 3300 then
        ...
        bpcommnex:sendCommsMessage(
            player,
            _(
                "audio-incCall",
                "Audio message received. Auto-transcribed into log. Stored for playback: AMBGREMUS004"
            )
        )
        player:addToShipLog(
            _(
                "audio-shipLog",
                "[AMBGREMUS004](Ambassador Gremus) Thanks for bringing me aboard. Please transport me to Ningling."
            ),
            "Yellow"
        )
        if player.play_msg_gremus_2_button == nil then
            ...
            player:addCustomButton(
                "Relay",
                player.play_msg_gremus_2_button,
                _("audio-buttonRelay", "|> AMBGREMUS004"),
                function()
...
function gotoNingling(delta) --Wait for Gremus msg, set meet time
    ...
    if player:isDocked(ningling) then
        ningling:sendCommsMessage(
            player,
            _(
                "audio-incCall",
                "Audio message received. Auto-transcribed into log. Stored for playback: NINGPCLO002"
            )
        )
        player:addToShipLog(
            _(
                "audio-shipLog",
                "[NINGPCLO002](Ningling Protocol Officer) Ambassador Gremus arrived. The ambassador is scheduled for a brief meeting with liaison Fordina. After that meeting, you will be asked to transport the ambassador to Goltin 7. We will contact you after the meeting."
            ),
            "Yellow"
        )
        if player.play_msg_protocol_button == nil then
            ...
            player:addCustomButton(
                "Relay",
                player.play_msg_protocol_button,
                _("audio-buttonRelay", "|> NINGPCLO002"),
                function()
...
function waitForAmbassador(delta) --When meeting completes, request dock for next goal
    ...
    if getScenarioTime() > meeting_time and not player:isDocked(ningling) then
        ningling:sendCommsMessage(
            ...
            _(
                "audio-incCall",
                "Audio message received. Auto-transcribed into log. Stored for playback: AMBGREMUS007"
            )
        )
        player:addToShipLog(
            string.format(
                _(
                    "audio-shipLog",
                    "[AMBGREMUS007](Ambassador Gremus) %s, I am ready to be transported to Goltin 7. Please dock with Ningling"
                ),
                playerCallSign
            ),
            "Yellow"
        ...
        if player.play_msg_gremus_3_button == nil then
            ...
            player:addCustomButton(
                "Relay",
                player.play_msg_gremus_3_button,
                _("audio-buttonRelay", "|> AMBGREMUS007"),
                function()
...
function getFromNingling(delta) --Goltin 7 goal, create planet, start sub-plots
    ...
    if player:isDocked(ningling) then
        ningling:sendCommsMessage(
            ...
            _(
                "audio-incCall",
                "Audio message received. Auto-transcribed into log. Stored for playback: AMBGREMUS021"
            )
        )
        player:addToShipLog(
            _(
                "audio-shipLog",
                "[AMBGREMUS021](Ambassador Gremus) Thank you for waiting and then for coming back and getting me. I needed the information provided by liaison Fordina to facilitate negotiations at Goltin 7. Let us away!"
            ),
            "Yellow"
        )
        player:addToShipLog(
            _(
                "upgrade-shipLog",
                "Reconfigured beam weapons: pointed one forward and increased its range and narrowed its focus"
            ),
            "Magenta"
        )
        if difficulty_variation ~= "Hard" then
            ...
            player:addToShipLog(
                _(
                    "upgrade-shipLog",
                    "Also increased the top speed of your impulse engine"
                ),
                "Magenta"
            )
        end
        if player.play_msg_gremus_4_button == nil then
            ...
            player:addCustomButton(
                "Relay",
                player.play_msg_gremus_4_button,
                _("audio-buttonRelay", "|> AMBGREMUS021"),
                function()
        ...
        goltin = Planet()
            :setPosition(93150, 21387)
            :setPlanetRadius(3000)
            :setDistanceFromMovementPlane(-2000)
            :setPlanetSurfaceTexture("planets/gas-1.png")
            :setAxialRotationTime(80.0)
...
function travelGoltin(delta) --Go to Goltin, win if research complete or identify research as goal
    ...
    if artifact_research_count > 0 then
        if distance(player, goltin) < 3300 then
            globalMessage(
                _("msgMainscreen", [[Goltin 7 welcomes ambassador Gremus]])
            )
            goltincomms:sendCommsMessage(
                player,
                string.format(
                    _(
                        "audio-incCall",
                        "(Ambassador Gremus) Thanks for transporting me, %s. Tensions are high, but I think negotiations will succeed.\nIn the meantime, be careful of hostile ships."
                    ),
                    playerCallSign
                )
            )
        ...
        if distance(player, goltin) < 3300 then
            goltincomms:sendCommsMessage(
                ...
                _(
                    "audio-incCall",
                    "Audio message received. Auto-transcribed into log. Stored for playback: AMBGREMUS032"
                )
            )
            player:addToShipLog(
                string.format(
                    _(
                        "audio-shipLog",
                        "[AMBGREMUS032](Ambassador Gremus) Thanks for transporting me, %s. I will need artifact research for successful negotiation. Please return with that research when you can."
                    ),
                    playerCallSign
                ),
                "Yellow"
            ...
            if player.play_msg_gremus_6_button == nil then
                ...
                player:addCustomButton(
                    "Relay",
                    player.play_msg_gremus_6_button,
                    _("audio-buttonRelay", "|> AMBGREMUS021"),
                    function()
        ...
        if distance(player, goltin) < 3300 then
            ...
            goltincomms:sendCommsMessage(
                ...
                string.format(
                    _(
                        "audio-incCall",
                        "(Ambassador Gremus) Thanks for researching the artifacts, %s. Tensions are high, but I think negotiations will succeed. In the meantime, be careful of hostile ships."
                    ),
                    playerCallSign
                )
            )
...
function revolutionFomenting(delta) --At foment time, send fomenting msg (limited time) and set revolution time
    ...
    if getScenarioTime() > foment_time then
        bpcommnex:sendCommsMessage(
            ...
            _(
                "audio-incCall",
                "Audio message received. Auto-transcribed into log. Stored for playback: AMBGREMUS001"
            )
        )
        player:addToShipLog(
            _(
                "audio-shipLog",
                "[AMBGREMUS001](Ambassador Gremus) I am glad you are coming to get me. There is serious unrest here on Balindor Prime. I am not sure how long I am going to survive. Please hurry, I can hear a mob outside my compound."
            ),
            "Yellow"
        )
        if player.play_msg_gremus_1_button == nil then
            ...
            player:addCustomButton(
                "Relay",
                player.play_msg_gremus_1_button,
                _("audio-buttonRelay", "|> AMBGREMUS001"),
                function()
    ...
    if getScenarioTime() > breakout_time then --Handle revolution (lose mission or continue)
        if ambassadorEscapedBalindor then
            bpcommnex:sendCommsMessage(
                ...
                _(
                    "audio-incCall",
                    "Audio message received. Auto-transcribed into log. Stored for playback: GREMUSGRD003"
                )
            )
            player:addToShipLog(
                _(
                    "audio-shipLog",
                    "[GREMUSGRD003](Compound Sentry) You got ambassador Gremus just in time. We barely escaped the mob with our lives. I don't recommend bringing the ambassador back anytime soon."
                ),
                "Yellow"
            )
            if player.play_msg_sentry_1_button == nil then
                ...
                player:addCustomButton(
                    "Relay",
                    player.play_msg_sentry_1_button,
                    _("audio-buttonRelay", "|> GREMUSGRD003"),
                    function()
            ...
            globalMessage(
                _(
                    "audio-msgMainscreen",
                    [[Ambassador lost to hostile mob. The Kraylors are victorious]]
                )
            )
            bpcommnex:sendCommsMessage(
                player,
                _(
                    "audio-incCall",
                    [[(Compound Sentry) I'm sad to report the loss of ambassador Gremus to a hostile mob.]]
                )
            )
        ...
        if mob_minutes <= 0 then
            mob_label = string.format(
                _("audio-tabRelay&Operations", "%s %i"),
                mob_label,
                mob_seconds
            )
        else
            mob_label = string.format(
                _("audio-tabRelay&Operations", "%s %i:%.2i"),
                mob_label,
                mob_minutes,
                mob_seconds
            )
...
function balindorInterceptor(delta) --Mission prevention enemies
    ...
    if distance(player, -50500, 84000) < 35000 then
        ...
        local x, y = player:getPosition()
        kraylorBalindorInterceptor1 = CpuShip()
            :setTemplate("Piranha F8")
            :setFaction("Kraylor")
            :setPosition(x - ao, y + ao)
            :setHeading(45)
        kraylorBalindorInterceptor1
            :orderAttack(player)
            :setCallSign(generateCallSign(nil, "Kraylor"))
        table.insert(
            kraylorBalindorInterceptorList,
        ...
        kraylorBalindorInterceptor2 = CpuShip()
            :setTemplate("Piranha F8")
            :setFaction("Kraylor")
            :setPosition(x - (ao + fo), y + ao)
            :setHeading(45)
        kraylorBalindorInterceptor2
            :orderFlyFormation(kraylorBalindorInterceptor1, fo, 0)
            :setCallSign(generateCallSign(nil, "Kraylor"))
        table.insert(
            kraylorBalindorInterceptorList,
            kraylorBalindorInterceptor2
        )
        kraylorBalindorInterceptor3 = CpuShip()
            :setTemplate("Piranha F8")
            :setFaction("Kraylor")
            :setPosition(x + ao, y - ao)
            :setHeading(225)
        kraylorBalindorInterceptor3
            :orderAttack(player)
            :setCallSign(generateCallSign(nil, "Kraylor"))
        table.insert(
            kraylorBalindorInterceptorList,
        ...
        kraylorBalindorInterceptor4 = CpuShip()
            :setTemplate("Piranha F8")
            :setFaction("Kraylor")
            :setPosition(x + ao + fo, y - ao)
            :setHeading(225)
        kraylorBalindorInterceptor4
            :orderFlyFormation(kraylorBalindorInterceptor3, -fo, 0)
            :setCallSign(generateCallSign(nil, "Kraylor"))
        table.insert(
            kraylorBalindorInterceptorList,
            kraylorBalindorInterceptor4
        ...
        if difficulty_variation ~= "Easy" then
            kraylorBalindorInterceptor5 = CpuShip()
                :setTemplate("Piranha F8")
                :setFaction("Kraylor")
                :setPosition(x - ao, y + ao + fo)
                :setHeading(45)
            kraylorBalindorInterceptor5
                :orderFlyFormation(kraylorBalindorInterceptor1, 0, fo)
                :setCallSign(generateCallSign(nil, "Kraylor"))
            table.insert(
                kraylorBalindorInterceptorList,
                kraylorBalindorInterceptor5
            )
            kraylorBalindorInterceptor6 = CpuShip()
                :setTemplate("Piranha F8")
                :setFaction("Kraylor")
                :setPosition(x - (ao + fo), y + ao + fo)
                :setHeading(45)
            kraylorBalindorInterceptor6
                :orderFlyFormation(kraylorBalindorInterceptor1, fo, fo)
                :setCallSign(generateCallSign(nil, "Kraylor"))
            table.insert(
                kraylorBalindorInterceptorList,
                kraylorBalindorInterceptor6
            )
            kraylorBalindorInterceptor7 = CpuShip()
                :setTemplate("Piranha F8")
                :setFaction("Kraylor")
                :setPosition(x + ao, y - (ao + fo))
                :setHeading(225)
            kraylorBalindorInterceptor7
                :orderFlyFormation(kraylorBalindorInterceptor3, 0, -fo)
                :setCallSign(generateCallSign(nil, "Kraylor"))
            table.insert(
                kraylorBalindorInterceptorList,
                kraylorBalindorInterceptor7
            )
            kraylorBalindorInterceptor8 = CpuShip()
                :setTemplate("Piranha F8")
                :setFaction("Kraylor")
                :setPosition(x + ao + fo, y - (ao + fo))
                :setHeading(225)
            kraylorBalindorInterceptor8
                :orderFlyFormation(kraylorBalindorInterceptor3, -fo, -fo)
                :setCallSign(generateCallSign(nil, "Kraylor"))
            table.insert(
                kraylorBalindorInterceptorList,
                kraylorBalindorInterceptor8
        ...
        if difficulty_variation == "Hard" then
            kraylorBalindorInterceptor9 = CpuShip()
                :setTemplate("Piranha F8")
                :setFaction("Kraylor")
                :setPosition(x - ao, y + ao + fo * 2)
                :setHeading(45)
            kraylorBalindorInterceptor9
                :orderFlyFormation(kraylorBalindorInterceptor1, 0, fo * 2)
                :setCallSign(generateCallSign(nil, "Kraylor"))
            table.insert(
                kraylorBalindorInterceptorList,
                kraylorBalindorInterceptor9
            )
            kraylorBalindorInterceptor10 = CpuShip()
                :setTemplate("Piranha F8")
                :setFaction("Kraylor")
                :setPosition(x - (ao + fo * 2), y + ao)
                :setHeading(45)
            kraylorBalindorInterceptor10
                :orderFlyFormation(kraylorBalindorInterceptor1, fo * 2, 0)
                :setCallSign(generateCallSign(nil, "Kraylor"))
            table.insert(
                kraylorBalindorInterceptorList,
                kraylorBalindorInterceptor10
            )
            kraylorBalindorInterceptor11 = CpuShip()
                :setTemplate("Piranha F8")
                :setFaction("Kraylor")
                :setPosition(x + ao, y - (ao + fo * 2))
                :setHeading(225)
            kraylorBalindorInterceptor11
                :orderFlyFormation(kraylorBalindorInterceptor3, 0, -fo * 2)
                :setCallSign(generateCallSign(nil, "Kraylor"))
            table.insert(
                kraylorBalindorInterceptorList,
                kraylorBalindorInterceptor11
            )
            kraylorBalindorInterceptor12 = CpuShip()
                :setTemplate("Piranha F8")
                :setFaction("Kraylor")
                :setPosition(x + ao + fo * 2, y - ao)
                :setHeading(225)
            kraylorBalindorInterceptor12
                :orderFlyFormation(kraylorBalindorInterceptor3, -fo * 2, 0)
                :setCallSign(generateCallSign(nil, "Kraylor"))
            table.insert(
                kraylorBalindorInterceptorList,
                kraylorBalindorInterceptor12
...
function ningAttack(delta) --More enemies to stop mission
    ...
    if distance(player, balindorPrime) > 30000 then
        ...
        if difficulty_variation ~= "Easy" then
            kraylorNing7 = CpuShip()
                :setTemplate("Stalker Q7")
                :setFaction("Kraylor")
                :setPosition(x - fo, y - ao - fo * 2)
                :setHeading(180)
            kraylorNing7
                :orderFlyFormation(kraylorNing1, -fo, -fo * 2)
                :setCallSign(generateCallSign(nil, "Kraylor"))
            table.insert(kraylorNingList, kraylorNing7)
            kraylorNing9 = CpuShip()
                :setTemplate("Stalker Q7")
                :setFaction("Kraylor")
                :setPosition(x - fo, y + ao + fo * 2)
                :setHeading(0)
            kraylorNing9
                :orderFlyFormation(kraylorNing4, -fo, fo * 2)
                :setCallSign(generateCallSign(nil, "Kraylor"))
            table.insert(kraylorNingList, kraylorNing9)
        end
        if difficulty_variation == "Hard" then
            kraylorNing11 = CpuShip()
                :setTemplate("Stalker Q7")
                :setFaction("Kraylor")
                :setPosition(x - fo, y - ao + fo * 2)
                :setHeading(180)
...
function ningWait(delta) --While waiting, more enemies arrive to try to stop mission
    ...
    if difficulty_variation ~= "Easy" then
        waitNing2 = CpuShip()
            ...
            :setHeading(315)
        waitNing2
            :orderFlyFormation(waitNing1, fo, 0)
            :setCallSign(generateCallSign(nil, "Kraylor"))
        ...
        waitNing3 = CpuShip()
            ...
            :setHeading(315)
        waitNing3
            :orderFlyFormation(waitNing1, 0, fo)
            :setCallSign(generateCallSign(nil, "Kraylor"))
    ...
    if difficulty_variation == "Hard" then
        waitNing4 = CpuShip()
            ...
            :setHeading(315)
        waitNing4
            :orderFlyFormation(waitNing1, fo * 2, 0)
            :setCallSign(generateCallSign(nil, "Kraylor"))
        ...
        waitNing5 = CpuShip()
            ...
            :setHeading(315)
        waitNing5
            :orderFlyFormation(waitNing1, 0, fo * 2)
            :setCallSign(generateCallSign(nil, "Kraylor"))
...
function artifactResearch(delta) --Expand artifact sub-plot after player leaves Ningling
    ...
    if distance(player, ningling) > 10000 then
        ningling:sendCommsMessage(
            ...
            _(
                "audio-incCall",
                "Audio message received. Auto-transcribed into log. Stored for playback: LSNFRDNA009"
            )
        )
        player:addToShipLog(
            _(
                "audio-shipLog",
                "[LSNFRDNA009](Liaison Fordina) Ambassador Gremus, we just received that follow-up information from Goltin 7 we spoke of. It seems they want additional information about several artifacts. Some of these have been reported by stations in the area: Pangora, Nakor and Science-37."
            ),
            "Yellow"
        )
        if player.play_msg_fordina_button == nil then
            ...
            player:addCustomButton(
                "Relay",
                player.play_msg_fordina_button,
                _("audio-buttonRelay", "|> LSNFRDNA009"),
                function()
...
function artifactByStation(delta) --When player docks, create nearby artifact. Enable comms message additions for station
    ...
    if player:isDocked(stationPangora) then
        if nearPangora == "ready" then
            ...
            nPangora = Artifact()
                :setPosition(x + 35000, y + 38000)
                :setScanningParameters(3, 2)
                :setRadarSignatureInfo(random(0.2, 0.8), random(0.2, 0.8), random(0.2, 0.8))
            ...
            nPangora:setDescriptions(
                _(
                    "scienceDescription-artifact",
                    "Unusual object floating in space"
                ),
                string.format(
                    _(
                        "scienceDescription-artifact",
...
Doppler instability: %i]]
                    ...
                    nPangora.ionic_phase_shift,
                    nPangora.doppler_instability
                )
            )
            nearPangora = "created"
        end
    ...
    if player:isDocked(stationNakor) then
        if nearNakor == "ready" then
            ...
            nNakor = Artifact()
                :setPosition(x - 35000, y - 36000)
                :setScanningParameters(2, 3)
                :setRadarSignatureInfo(random(0.2, 0.5), random(0.2, 0.5), random(0.2, 0.8))
            ...
            nNakor:setDescription(
                _(
                    "scienceDescription-artifact",
                    "Object with unusual visual properties"
                ),
                string.format(
                    _(
                        "scienceDescription-artifact",
...
Gravity disruption: %i]]
    ...
    if player:isDocked(science37) then
        if nearScience37 == "ready" then
            ...
            nScience37 = Artifact()
                :setPosition(x + 1000, y - 40000)
                :setScanningParameters(4, 1)
                :setRadarSignatureInfo(random(0.3, 0.9), random(0.1, 0.5), random(0.2, 0.4))
            ...
            nScience37:setDescription(
                _(
                    "scienceDescription-artifact",
                    "Small object floating in space"
                ),
                string.format(
                    _(
                        "scienceDescription-artifact",
...
Theta particle emission: %i]]
                    ...
                    nScience37.theta_particle_emission
                )
            )
...
Doppler instability: %i]]
    ...
    if nScience37 ~= nil and nScience37:isValid() then
        if
            nScience37:isScannedBy(player)
            and nScience37.already_scanned == nil
        then
            artifact_research_count = artifact_research_count + 1
...
function pangoraArtifactChange(delta)
    ...
    if player.pangora_reading_change_message == nil then
        player:addCustomMessage(
            "Science",
            _("artifact-msgScience", "Warning"),
            _(
                "artifact-msgScience",
                "The readings on the Pangora artifact have changed"
            )
        )
    ...
    if getScenarioTime() > pangora_explode_time then
        if distance(player, nPangora) < 6000 then
            player:setSystemHealth(
                "reactor",
                player:getSystemHealth("reactor") - random(0.0, 0.5)
            )
            player:setSystemHealth(
                "beamweapons",
                player:getSystemHealth("beamweapons") - random(0.0, 0.5)
            )
            player:setSystemHealth(
                "maneuver",
                player:getSystemHealth("maneuver") - random(0.0, 0.5)
            )
            player:setSystemHealth(
                "missilesystem",
                player:getSystemHealth("missilesystem") - random(0.0, 0.5)
            )
            player:setSystemHealth(
                "impulse",
                player:getSystemHealth("impulse") - random(1.3, 1.5)
            )
            player:setSystemHealth(
                "warp",
                player:getSystemHealth("warp") - random(1.3, 1.5)
            )
            player:setSystemHealth(
                "jumpdrive",
                player:getSystemHealth("jumpdrive") - random(1.3, 1.5)
            )
            player:setSystemHealth(
                "frontshield",
                player:getSystemHealth("frontshield") - random(0.0, 0.5)
            )
            player:setSystemHealth(
                "rearshield",
                player:getSystemHealth("rearshield") - random(0.0, 0.5)
            )
        end
        nPangora:explode()
        plot4 = nil
...
function maintainTerrorists()
    if terrorist_list == nil then
        ...
        for i = 1, 6 do
            local tx, ty =
                vectorFromAngle(attack_angle, player:getLongRangeRadarRange())
            local ship = CpuShip()
                :setTemplate("Stalker Q7")
                :setPosition(px + tx, py + ty)
                :setFaction("Kraylor")
                ...
                if ship:isValid() then
                    ship:sendCommsMessage(
                        ...
                        _(
                            ...
                            "We apologize for the imminent destruction of your ship, but you are harboring Ambassador Gremus aboard, a known menace to polite society."
                        )
                    )
...
function handleDockedState()
    ...
    local weapon_prompts = {
        ["Homing"] = {
            ...
            string.format(
                _(
                    "ammo-comms",
                    "Do you have extra homing missiles? (%d rep each)"
                ),
                getWeaponCost("Homing")
            ),
            string.format(
                _(
                    "ammo-comms",
                    "We could use some homing missiles. (%d rep each)"
                ),
                getWeaponCost("Homing")
            ),
        },
        ["HVLI"] = {
            ...
            string.format(
                _("ammo-comms", "What about HVLI? (%d rep each)"),
                getWeaponCost("HVLI")
            ),
            string.format(
                _(
                    "ammo-comms",
                    "We need some High Velocity Lead Impactors. (%d rep each)"
                ),
                getWeaponCost("HVLI")
            ),
        },
        ["Mine"] = {
            string.format(
                _("ammo-comms", "Please restock our mines. (%d rep each)"),
                getWeaponCost("Mine")
            ),
            string.format(
                _("ammo-comms", "How about mines? (%d rep each)"),
                getWeaponCost("Mine")
            ),
            string.format(
                _("ammo-comms", "We are running low on mines. (%d rep each)"),
                getWeaponCost("Mine")
            ),
        },
        ["EMP"] = {
            string.format(
                _(
                    "ammo-comms",
                    "Please restock our EMP missiles. (%d rep each)"
                ),
                getWeaponCost("EMP")
            ),
            string.format(
                _("ammo-comms", "Got any EMPs? (%d rep each)"),
                getWeaponCost("EMP")
            ),
            string.format(
                _(
                    "ammo-comms",
                    "We need Electro-Magnetic Pulse missiles. (%d rep each)"
                ),
                getWeaponCost("EMP")
            ),
        },
        ["Nuke"] = {
            ...
            string.format(
                _("ammo-comms", "We really need some nukes. (%d rep each)"),
                getWeaponCost("Nuke")
            ),
            string.format(
                _(
                    "ammo-comms",
                    "We could use some nuclear missiles. (%d rep each)"
                ),
                getWeaponCost("Nuke")
            ),
        },
    ...
    if isAllowedTo(askForOrders) then
        addCommsReply(
            ...
            function()
                oMessage =
                    _("orders-comms", "Whatever ambassador Gremus says. ")
                if
                    plot1 == chasePlayer
                    or plot1 == getAmbassador
                    or plot1 == ambassadorAboard
                then
                    oMessage = _(
                        "orders-comms",
                        "Current Orders: Get ambassador Gremus from Balindor Prime. Avoid contact if possible. "
                    )
                elseif plot1 == gotoNingling then
                    oMessage = _(
                        "orders-comms",
                        "Current Orders: Transport ambassador Gremus to Ningling. "
                    )
                elseif plot1 == waitForAmbassador then
                    oMessage = _(
                        "orders-comms",
                        "Current Orders: Wait for ambassador Gremus to complete business at Ningling. "
                    )
                elseif plot1 == getFromNingling then
                    oMessage = _(
                        "orders-comms",
                        "Current Orders: Dock with Ningling to get ambassador Gremus. "
                    )
                elseif plot1 == travelGoltin then
                    oMessage = _(
                        "orders-comms",
                        "Current Orders: Transport ambassador Gremus to Goltin 7. "
                    )
                end
                if plot3 == artifactResearch or plot3 == artifactByStation then
                    oMessage = string.format(
                        _(
                            "artifactOrders-comms",
                            "%sAdditional Orders: Research artifacts. Some artifacts reported near Pangora, Nakor and Science-37. "
                        ),
                        oMessage
                    )
                    if
                        plot1 == departForResearch
                        or plot1 == goltinAndResearch
                    then
                        oMessage = string.format(
                            _(
                                "artifactOrders-comms",
                                "%sProvide artifact research to ambassador Gremus on Goltin 7. "
                            ),
                            oMessage
                        )
                    end
...
function handleUndockedState()
    ...
    if isAllowedTo(comms_target.comms_data.services.supplydrop) then
        addCommsReply(
            string.format(
                _("stationAssist-comms", "Can you send a supply drop? (%s rep)"),
    ...
    if isAllowedTo(comms_target.comms_data.services.reinforcements) then
        addCommsReply(
            string.format(
                _("stationAssist-comms", "Please send reinforcements! (rep %s)"),
...
function helpfulWaypoints()
    ...
    points_of_interest = {
        {
            id = "askForBalindorLocation",
            prompt = _("path-comms", "Where is Balindor Prime?"),
            resp = _("path-comms", "planet Balindor Prime"),
            poi = balindorPrime,
        },
        {
            id = "askForNingLocation",
            prompt = _("path-comms", "Where is Ningling?"),
            resp = _("path-comms", "Ningling station"),
            poi = ningling,
        },
        {
            id = "askForGoltinLocation",
            prompt = _("path-comms", "Where is Goltin 7?"),
            resp = _("path-comms", "planet Goltin 7"),
            poi = goltin,
        },
        {
            id = "askForPangoraLocation",
            prompt = _("path-comms", "Where is Pangora?"),
            resp = _("path-comms", "Pangora station"),
            poi = stationPangora,
        },
        {
            id = "askForNakorLocation",
            prompt = _("path-comms", "Where is Nakor?"),
            resp = _("path-comms", "Nakor station"),
            poi = stationNakor,
        },
        {
            id = "askForScience37Location",
            prompt = _("path-comms", "Where is Science-37?"),
            resp = _("path-comms", "station Science-37"),
            poi = science37,
        },
    }
                ...
                if replace_waypoint then
                    setCommsMessage(
                        string.format(
                            _(
                                "path-comms",
                                "Replaced former waypoint 9 with new waypoint 9 for %s.\nYou reached the 9 waypoint maximum."
                            ),
                            point_of_interest.resp
                        )
                    )
                else
                    setCommsMessage(
                        string.format(
                            _(
                                "path-comms",
                                "Added a waypoint to your navigation system for %s"
                            ),
                            point_of_interest.resp
                        )
                    )
    ...
    local artifact_reports = {
        {
            id = "askForPangoraArtifactLocation",
            prompt = _(
                "artifact-comms",
                "Any reports of artifacts near Pangora?"
            ),
            resp = _(
                "artifact-comms",
                "Some freighters report seeing an artifact on approximate heading 135 from Pangora."
            ),
        },
        {
            id = "askForNakorArtifactLocation",
            prompt = _("artifact-comms", "Heard of any artifacts near Nakor?"),
            resp = _(
                "artifact-comms",
                "Some have reported seeing object on approximate heading of 315 from Nakor station."
            ),
        },
        {
            id = "askForScience37ArtifactLocation",
            prompt = _(
                "artifact-comms",
                "Has anyone reported seeing artifacts near Science-37?"
            ),
            resp = _(
                "artifact-comms",
                "Freighters doing business here occasionally report an objecton approximate heading zero from Science-37 station."
            ),
        },
    }
...
function update(delta)
    if not player:isValid() then
        globalMessage(
            string.format(
                _(
                    "msgMainscreen",
                    "%s destroyed. Ambassador Gremus killed.\nWar begins on Goltin 7. Disgrace abounds."
                ),
                playerCallSign
            )
        )
    ...
    if plot1 == nil then
        globalMessage(
            _(
                "msgMainscreen",
                "Congratulations! You delivered ambassador Gremus\n...and did other things, too."
            )
        )
        victory("Human Navy")
        return
    ...
    if bpcommnex ~= nil and bpcommnex:isValid() and balindorPrime ~= nil then
        bpcommnex.bp_angle = bpcommnex.bp_angle + delta * 0.25
        if bpcommnex.bp_angle > 360 then
            bpcommnex.bp_angle = bpcommnex.bp_angle - 360
        end
        local sx, sy =
            vectorFromAngleNorth(bpcommnex.bp_angle, bpcommnex.bp_distance)
