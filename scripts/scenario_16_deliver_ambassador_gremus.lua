    ...
    if player:isDocked(stationPangora) then
        if nearPangora == "ready" then
            ...
            nPangora = Artifact()
                ...
                :setRadarSignatureInfo(random(2, 8), random(2, 8), random(2, 8))
    ...
    if player:isDocked(stationNakor) then
        if nearNakor == "ready" then
            ...
            nNakor = Artifact()
                ...
                :setRadarSignatureInfo(random(2, 5), random(2, 5), random(2, 8))
    ...
    if player:isDocked(science37) then
        if nearScience37 == "ready" then
            ...
            nScience37 = Artifact()
                ...
                :setRadarSignatureInfo(random(3, 9), random(1, 5), random(2, 4))
