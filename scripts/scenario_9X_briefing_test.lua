...
function init()
    ...
    setBriefingPage(
        ...
        1,
        _(
            [[[If you run stock missions, you can make do without GM, but a lot of missions have some controls to tweak that exact mission on the fly.
...
If you want to create your own scenarios, see mission scripting page from there and also mission scripting tutorial on EE's web page. But that is entirely new can of worms.]]
        ),
        "images/black_hole_wireframe.jpg",
        "audio/scenario/55/sa_55_Commander1.ogg",
        8
    )
    setBriefingPage(
        player,
        ...
        "images/frequency_graph.png",
        "audio/scenario/55/sa_55_Commander2.ogg",
        10
    )
    setBriefingPage(
        player,
        3,
        _("Hack Minigames"),
        "images/hack_minigames.jpg",
        "audio/scenario/55/sa_55_Manager1.ogg",
        6
    )
    setBriefingPage(
        player,
        4,
        _("Radar Rings"),
        "images/radar_rings.png",
        "audio/scenario/55/sa_55_Maria1.ogg",
        9
    )
    setBriefingPage(
        player,
        ...
        _("Wormhole"),
        "images/wormhole.jpg",
        "audio/scenario/55/sa_55_Maria2.ogg",
        13
    )
end
