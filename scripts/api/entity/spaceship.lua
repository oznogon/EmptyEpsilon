...
--- Returns whether this ship has been identified by the given entity as either hostile or friendly.
...
--- Returns whether this ship has been fully scanned by the given entity.
--- See also isScannedBy().
...
--- Returns whether this ship has been fully scanned by the given faction.
...
--- Returns the hacked level for the given system on this ship.
...
--- Sets the hacked level for the given system on this ship.
...
--- Returns the given system's health on this ship.
...
--- Sets the given system's health on this ship.
--- System health is related to damage, and is separate from its hacked level.
...
--- Returns the given system's maximum health on this ship.
...
--- Sets the given system's maximum health on this ship.
...
--- Returns the given system's heat level on this ship.
...
--- Sets the given system's heat level on this ship.
...
--- Sets the relative power drain factor? for the given system in this ship.
...
--- Returns the coolant distribution for the given system in this ship.
...
--- Sets the coolant quantity for the given system in this ship.
--- CPU ships don't generate or manage heat. Setting this has no effect on them.
...
--- Sets the ship's combat maneuvering capacities.
...
--- Defines whether the ship has a jump drive.
...
--- Sets this ship's current jump drive charge.
...
--- A ship with a jump drive can jump only when this value is equal to or greater than the ship's maximum jump range.
...
--- - index: Each beam weapon on this ship must have a unique index.
...
--- To create a turreted beam, also add setBeamWeaponTurret(), and set the beam weapon's arc to be smaller than the turret's arc.
--- Example:
...
--- - index: Must match the index of an existing beam weapon on this ship.
...
--- To create a turreted beam, also add setBeamWeapon(), and set the beam weapon's arc to be smaller than the turret's arc.
--- Example:
...
--- 0: Broadcast to all friendly ships
--- 1: Broadcast to all friendly and neutral ships
--- 2: Broadcast to all ships, including enemies
--- Providing an invalid threshold value defaults to broadcasting only to friendly ships.
--- Examples:
...
--- Sets the scan state of this ship for every faction.
...
--- Sets the scan state of this ship for a given faction.
