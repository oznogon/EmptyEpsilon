...
local neutral =
    FactionInfo():setName("Independent"):setLocaleName(_("Independent"))
...
local arlenians =
    FactionInfo():setName("Arlenians"):setLocaleName(_("Arlenians"))
arlenians:setGMColor(255, 128, 0)
arlenians:setEnemy(kraylor)
arlenians:setDescription(
    _(
