...
uniform mat4 model;
uniform vec4 spriteSheetParams; // x=columns, y=rows, z=currentFrame, w=unused
...
void main()
{
    ...
    float columns = spriteSheetParams.x;
    float rows = spriteSheetParams.y;
    float frame = spriteSheetParams.z;
