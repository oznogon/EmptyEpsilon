...
{
    //                  speed, turnrate, lifetime, color,               homing_range, sound_effect
    MissileWeaponData( 200.0f, 10.0f, 27.0f, glm::u8vec4(255, 200,   0, 255), 1200.0, "sfx/rlaunch.wav"),        // MW_Homing
    MissileWeaponData( 200.0f, 10.0f, 27.0f, glm::u8vec4(255, 100,  32, 255),  500.0, "sfx/rlaunch.wav"),        // MW_Nuke
    MissileWeaponData( 100.0f,  0.0f, 10.0f, glm::u8vec4(255, 255, 255, 255),    0.0, "sfx/missile_launch.wav"), // MW_Mine, lifetime is used at time which the mine is ejecting from the ship
    MissileWeaponData( 200.0f, 10.0f, 27.0f, glm::u8vec4(100,  32, 255, 255),  500.0, "sfx/rlaunch.wav"),        // MW_EMP
    MissileWeaponData( 500.0f,  0.0f, 13.5f, glm::u8vec4(200, 200, 200, 255),    0.0, "sfx/hvli_fire.wav"),      // MW_HVLI
    MissileWeaponData(1000.0f,  0.0f,  3.0f, glm::u8vec4(200, 200, 255, 255),    0.0, "sfx/hvpe_fire.wav"),      // MW_HVPE
};
