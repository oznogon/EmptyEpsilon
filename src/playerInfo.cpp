...
#include "screens/extra/utilityBeamScreen.h"
...
void PlayerInfo::spawnUI(int monitor_index, RenderLayer* render_layer)
{
    ...
    else
    {
        ...
        if (cps.has(CrewPosition::utilityBeam))
            screen->addStationTab(new UtilityBeamScreen(container), CrewPosition::utilityBeam, getCrewPositionName(CrewPosition::utilityBeam), getCrewPositionIcon(CrewPosition::utilityBeam));
...
string getCrewPositionName(CrewPosition position)
{
    ...
    case CrewPosition::utilityBeam: return tr("station","Utility Beam");
...
string getCrewPositionIcon(CrewPosition position)
{
    ...
    case CrewPosition::utilityBeam: return "gui/icons/system_utilitybeam";
    default: return "ErrUnk: " + string(static_cast<int>(position));
    }
}
