...
MainMenu::MainMenu()
{
    ...
    {
        (new GuiLabel(this, "UPGRADE", tr("Upgrade available: {version}").format({{"version", available_upgrade}}), 20))->setPosition(0, title_y + logo_size + 30, sp::Alignment::TopCenter)->setSize(0, 20);        
    }
