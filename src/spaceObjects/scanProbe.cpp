...
REGISTER_SCRIPT_SUBCLASS(ScanProbe, SpaceObject)
{
    ...
    /// Defines a function to call when the probe's lifetime expires.
    ...
    /// Defines a function to call when the probe is destroyed by damage.
