...
class TractorBeamSystem : public sp::ecs::System, public Render3DInterface<TractorBeamEffect, true>, public RenderRadarInterface<TractorBeamSys, 21, RadarRenderSystem::FlagShortRange>
{
public:
