...
void Keys::CinematicKeys::init()
{
    ...
    toggle_manual_controls.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    ...
    cycle_camera_mode.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    cycle_camera_mode.setDefaultInteraction(sp::io::Keybinding::Interaction::Discrete);
    ...
    previous_camera_mode.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    previous_camera_mode.setDefaultInteraction(sp::io::Keybinding::Interaction::Discrete);
    next_camera_mode.setLabel(localized_category, tr("hotkey_Cinematic", "Cycle next camera mode"));
    next_camera_mode.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    next_camera_mode.setDefaultInteraction(sp::io::Keybinding::Interaction::Discrete);
    toggle_auto_zoom.setLabel(localized_category, tr("hotkey_Cinematic", "Toggle auto-zoom"));
    toggle_auto_zoom.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    toggle_target_lock.setLabel(localized_category, tr("hotkey_Cinematic", "Toggle target lock"));
    toggle_target_lock.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    camera_option.setLabel(localized_category, tr("hotkey_Cinematic", "Camera option"));
    camera_option.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    ...
    move_faster.setSupportedInteractions(sp::io::Keybinding::Interaction::Continuous);
    move_slower.setLabel(localized_category, tr("hotkey_Cinematic", "Move slower"));
    move_slower.setSupportedInteractions(sp::io::Keybinding::Interaction::Continuous);
}
...
void Keys::init()
{
    ...
    weapons_enemy_prev_target.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    weapons_enemy_prev_target.setDefaultInteraction(sp::io::Keybinding::Interaction::Repeating);
    ...
    weapons_prev_target.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    weapons_prev_target.setDefaultInteraction(sp::io::Keybinding::Interaction::Repeating);
    ...
    science_select_prev_scannable.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    science_select_prev_scannable.setDefaultInteraction(sp::io::Keybinding::Interaction::Repeating);
    science_next_target.setLabel(tr("hotkey_menu", "Science"), tr("hotkey_Science", "Select next target (any)"));
    science_next_target.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    science_next_target.setDefaultInteraction(sp::io::Keybinding::Interaction::Repeating);
    science_prev_target.setLabel(tr("hotkey_menu", "Science"), tr("hotkey_Science", "Select previous target (any)"));
    science_prev_target.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    science_prev_target.setDefaultInteraction(sp::io::Keybinding::Interaction::Repeating);
    science_enemy_next_target.setLabel(tr("hotkey_menu", "Science"), tr("hotkey_Science", "Select next hostile target"));
    science_enemy_next_target.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    science_enemy_next_target.setDefaultInteraction(sp::io::Keybinding::Interaction::Repeating);
    science_enemy_prev_target.setLabel(tr("hotkey_menu", "Science"), tr("hotkey_Science", "Select previous hostile target"));
    science_enemy_prev_target.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    science_enemy_prev_target.setDefaultInteraction(sp::io::Keybinding::Interaction::Repeating);
    ...
    science_open_radar.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    science_open_database.setLabel(tr("hotkey_menu", "Science"), tr("hotkey_Science", "Open database view"));
    science_open_database.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    science_open_database_target.setLabel(tr("hotkey_menu", "Science"), tr("hotkey_Science", "Open database entry for target"));
    science_open_database_target.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    science_sidebar_prev.setLabel(tr("hotkey_menu", "Science"), tr("hotkey_Science", "Sidebar previous tab"));
    science_sidebar_prev.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    science_sidebar_next.setLabel(tr("hotkey_menu", "Science"), tr("hotkey_Science", "Sidebar next tab"));
    science_sidebar_next.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    science_sidebar_pager_prev.setLabel(tr("hotkey_menu", "Science"), tr("hotkey_Science", "Sidebar page previous"));
    science_sidebar_pager_prev.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    science_sidebar_pager_next.setLabel(tr("hotkey_menu", "Science"), tr("hotkey_Science", "Sidebar page next"));
    science_sidebar_pager_next.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    ...
    relay_open_comms.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    relay_start_hacking.setLabel(tr("hotkey_menu", "Relay"), tr("hotkey_Relay", "Start hacking target"));
    relay_start_hacking.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    relay_link_to_science.setLabel(tr("hotkey_menu", "Relay"), tr("hotkey_Relay", "Link to Science"));
    relay_link_to_science.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    relay_toggle_waypoint.setLabel(tr("hotkey_menu", "Relay"), tr("hotkey_Relay", "Toggle waypoint placement"));
    relay_toggle_waypoint.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    relay_delete_waypoint.setLabel(tr("hotkey_menu", "Relay"), tr("hotkey_Relay", "Delete selected waypoint"));
    relay_delete_waypoint.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    relay_launch_probe.setLabel(tr("hotkey_menu", "Relay"), tr("hotkey_Relay", "Toggle probe launch"));
    relay_launch_probe.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    relay_center_on_ship.setLabel(tr("hotkey_menu", "Relay"), tr("hotkey_Relay", "Center view on ship"));
    relay_center_on_ship.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    relay_toggle_ships_log.setLabel(tr("hotkey_menu", "Relay"), tr("hotkey_Relay", "Toggle ships log"));
    relay_toggle_ships_log.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    relay_prev_target.setLabel(tr("hotkey_menu", "Relay"), tr("hotkey_Relay", "Select previous target (any)"));
    relay_prev_target.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    relay_prev_target.setDefaultInteraction(sp::io::Keybinding::Interaction::Discrete);
    relay_next_target.setLabel(tr("hotkey_menu", "Relay"), tr("hotkey_Relay", "Select next target (any)"));
    relay_next_target.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    relay_next_target.setDefaultInteraction(sp::io::Keybinding::Interaction::Discrete);
    relay_enemy_prev_target.setLabel(tr("hotkey_menu", "Relay"), tr("hotkey_Relay", "Select previous hostile target"));
    relay_enemy_prev_target.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    relay_enemy_prev_target.setDefaultInteraction(sp::io::Keybinding::Interaction::Discrete);
    relay_enemy_next_target.setLabel(tr("hotkey_menu", "Relay"), tr("hotkey_Relay", "Select next hostile target"));
    relay_enemy_next_target.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    relay_enemy_next_target.setDefaultInteraction(sp::io::Keybinding::Interaction::Discrete);
    relay_prev_hackable.setLabel(tr("hotkey_menu", "Relay"), tr("hotkey_Relay", "Select previous hackable target"));
    relay_prev_hackable.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    relay_prev_hackable.setDefaultInteraction(sp::io::Keybinding::Interaction::Discrete);
    relay_next_hackable.setLabel(tr("hotkey_menu", "Relay"), tr("hotkey_Relay", "Select next hackable target"));
    relay_next_hackable.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    relay_next_hackable.setDefaultInteraction(sp::io::Keybinding::Interaction::Discrete);
    relay_prev_probe.setLabel(tr("hotkey_menu", "Relay"), tr("hotkey_Relay", "Select previous probe"));
    relay_prev_probe.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    relay_prev_probe.setDefaultInteraction(sp::io::Keybinding::Interaction::Discrete);
    relay_next_probe.setLabel(tr("hotkey_menu", "Relay"), tr("hotkey_Relay", "Select next probe"));
    relay_next_probe.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    relay_next_probe.setDefaultInteraction(sp::io::Keybinding::Interaction::Discrete);

    // Utility beam
    utilitybeam_toggle_active.setLabel(tr("hotkey_menu", "Utility beam"), tr("hotkey_UtilityBeam", "Activate utility beam"));
    utilitybeam_toggle_active.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    utilitybeam_bearing_right.setLabel(tr("hotkey_menu", "Utility beam"), tr("hotkey_UtilityBeam", "Rotate utility beam right"));
    utilitybeam_bearing_right.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating |
        sp::io::Keybinding::Interaction::Continuous |
        sp::io::Keybinding::Interaction::Axis0 |
    ...
    utilitybeam_bearing_right.setDefaultInteraction(sp::io::Keybinding::Interaction::Continuous);
    utilitybeam_bearing_right.setDefaultInteraction(sp::io::Keybinding::Type::JoystickAxis, sp::io::Keybinding::Interaction::Axis1);
    utilitybeam_bearing_right.setDefaultInteraction(sp::io::Keybinding::Type::ControllerAxis, sp::io::Keybinding::Interaction::Axis1);
    utilitybeam_bearing_left.setLabel(tr("hotkey_menu", "Utility beam"), tr("hotkey_UtilityBeam", "Rotate utility beam left"));
    utilitybeam_bearing_left.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating |
        sp::io::Keybinding::Interaction::Continuous |
        sp::io::Keybinding::Interaction::Axis0 |
    ...
    utilitybeam_bearing_left.setDefaultInteraction(sp::io::Keybinding::Interaction::Continuous);
    utilitybeam_bearing_left.setDefaultInteraction(sp::io::Keybinding::Type::JoystickAxis, sp::io::Keybinding::Interaction::Axis1);
    utilitybeam_bearing_left.setDefaultInteraction(sp::io::Keybinding::Type::ControllerAxis, sp::io::Keybinding::Interaction::Axis1);
    utilitybeam_arc_increase.setLabel(tr("hotkey_menu", "Utility beam"), tr("hotkey_UtilityBeam", "Increase utility beam arc"));
    utilitybeam_arc_increase.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating |
        sp::io::Keybinding::Interaction::Continuous |
        sp::io::Keybinding::Interaction::Axis0 |
    ...
    utilitybeam_arc_increase.setDefaultInteraction(sp::io::Keybinding::Interaction::Continuous);
    utilitybeam_arc_increase.setDefaultInteraction(sp::io::Keybinding::Type::JoystickAxis, sp::io::Keybinding::Interaction::Axis0);
    utilitybeam_arc_increase.setDefaultInteraction(sp::io::Keybinding::Type::ControllerAxis, sp::io::Keybinding::Interaction::Axis0);
    utilitybeam_arc_decrease.setLabel(tr("hotkey_menu", "Utility beam"), tr("hotkey_UtilityBeam", "Decrease utility beam arc"));
    utilitybeam_arc_decrease.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating |
        sp::io::Keybinding::Interaction::Continuous |
        sp::io::Keybinding::Interaction::Axis0 |
    ...
    utilitybeam_arc_decrease.setDefaultInteraction(sp::io::Keybinding::Interaction::Continuous);
    utilitybeam_arc_decrease.setDefaultInteraction(sp::io::Keybinding::Type::JoystickAxis, sp::io::Keybinding::Interaction::Axis0);
    utilitybeam_arc_decrease.setDefaultInteraction(sp::io::Keybinding::Type::ControllerAxis, sp::io::Keybinding::Interaction::Axis0);
    utilitybeam_range_increase.setLabel(tr("hotkey_menu", "Utility beam"), tr("hotkey_UtilityBeam", "Increase utility beam range"));
    utilitybeam_range_increase.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating |
        sp::io::Keybinding::Interaction::Continuous |
        sp::io::Keybinding::Interaction::Axis0 |
    ...
    utilitybeam_range_increase.setDefaultInteraction(sp::io::Keybinding::Interaction::Continuous);
    utilitybeam_range_increase.setDefaultInteraction(sp::io::Keybinding::Type::JoystickAxis, sp::io::Keybinding::Interaction::Axis0);
    utilitybeam_range_increase.setDefaultInteraction(sp::io::Keybinding::Type::ControllerAxis, sp::io::Keybinding::Interaction::Axis0);
    utilitybeam_range_decrease.setLabel(tr("hotkey_menu", "Utility beam"), tr("hotkey_UtilityBeam", "Decrease utility beam range"));
    utilitybeam_range_decrease.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating |
        sp::io::Keybinding::Interaction::Continuous |
        sp::io::Keybinding::Interaction::Axis0 |
    ...
    utilitybeam_range_decrease.setDefaultInteraction(sp::io::Keybinding::Interaction::Continuous);
    utilitybeam_range_decrease.setDefaultInteraction(sp::io::Keybinding::Type::JoystickAxis, sp::io::Keybinding::Interaction::Axis0);
    utilitybeam_range_decrease.setDefaultInteraction(sp::io::Keybinding::Type::ControllerAxis, sp::io::Keybinding::Interaction::Axis0);
    utilitybeam_mode_next.setLabel(tr("hotkey_menu", "Utility beam"), tr("hotkey_UtilityBeam", "Set next utility beam mode"));
    utilitybeam_mode_next.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    utilitybeam_mode_next.setDefaultInteraction(sp::io::Keybinding::Interaction::Discrete);
    utilitybeam_mode_prev.setLabel(tr("hotkey_menu", "Utility beam"), tr("hotkey_UtilityBeam", "Set previous utility beam mode"));
    utilitybeam_mode_prev.setSupportedInteractions(
        sp::io::Keybinding::Interaction::Discrete |
        sp::io::Keybinding::Interaction::Repeating
    );
    ...
    gm_show_waypoints.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
    gm_show_health_bars.setLabel(tr("hotkey_menu", "GM screen"), tr("hotkey_GM", "Show health bars (GM)"));
    gm_show_health_bars.setSupportedInteractions(sp::io::Keybinding::Interaction::Discrete);
