...
void initComponentScriptBindings()
{
    ...
    BIND_MEMBER(RawRadarSignatureInfo, thermal);
    ...
    BIND_MEMBER(DynamicRadarSignatureInfo, thermal);
    ...
    BIND_MEMBER(BeamWeaponTarget, entity);
    sp::script::ComponentHandler<MissileWeaponTarget>::name("missile_weapon_target");
    BIND_MEMBER(MissileWeaponTarget, entity);
    sp::script::ComponentHandler<HackTarget>::name("hack_target");
    BIND_MEMBER(HackTarget, entity);
    ...
    BIND_MEMBER(NebulaRenderer, seed);
