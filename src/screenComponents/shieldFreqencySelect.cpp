...
void GuiShieldFrequencySelect::onUpdate()
{
    ...
    {
        if (keys.weapons_shield_calibration_increase.isDiscreteStepDown() || keys.weapons_shield_calibration_increase.isRepeatReady())
        {
        ...
        if (keys.weapons_shield_calibration_decrease.isDiscreteStepDown() || keys.weapons_shield_calibration_decrease.isRepeatReady())
        {
        ...
        if (keys.weapons_shield_calibration_start.isDiscreteStepDown())
        {
            my_player_info->commandSetShieldFrequency(new_frequency->getSelectionIndex());
        }
    }
