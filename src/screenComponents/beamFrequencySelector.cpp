...
void GuiBeamFrequencySelector::onUpdate()
{
    ...
    {
        if (keys.weapons_beam_frequency_increase.isDiscreteStepDown() || keys.weapons_beam_frequency_increase.isRepeatReady())
        {
        ...
        if (keys.weapons_beam_frequency_decrease.isDiscreteStepDown() || keys.weapons_beam_frequency_decrease.isRepeatReady())
        {
