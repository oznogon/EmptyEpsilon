...
// The AcnDMXDevice talks the ACN E1.31 protocol, which is a UDP protocol for
// sending DMX messages through IP networks.
...
public:
    ...
    // Parameter: "resend_delay" Time between broadcast packets, in ms.
    //   Default "50"
    // Parameter: "multicast" Per default, sACN should be using multicast. But
    //   this implementation can also use broadcast. Default is to use
    //   broadcast. Set to 1 for multicast.
