...
"""
        ...
        stream.write('<p>By no means is this is a guide to help you write scenario scripts. See the <a href="https://daid.github.io/EmptyEpsilon/#tabs=4">EmptyEpsilon website</a> for the guide on scripting. ')
        stream.write("You can also refer to the existing scenarios, ship and model data files, and other contents of the scripts directory for examples.</p>")
        stream.write("</div>\n")
